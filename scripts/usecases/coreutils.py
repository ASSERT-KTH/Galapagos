...
class coreutils(case.LLVMCompilableUseCase):

    def __init__(self, function_name, original_project_folder, original_file_location, variant_text_location, line_start, line_end, name="coreutils", doreplace=True, real_name=""):
        super().__init__()
        # TODO: add warning for needed packages/libraries for coreutils's compilations to work (?)
        # logging.warning("Make sure <stuff here> is installed in your system, otherwise the compilation of coreutils wont work")
        self.name = name
