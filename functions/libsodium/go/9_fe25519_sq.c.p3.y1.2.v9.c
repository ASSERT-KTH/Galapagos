...
func fe25519_sq(h []int32, f []int32) {
    ...
    carry0 := (h0 + (1<<25)) >> 26
    h1 += int64(carry0)
    h0 -= int64(carry0) * (1<<26)
    carry4 := (h4 + (1<<25)) >> 26
    h5 += int64(carry4)
    h4 -= int64(carry4) * (1<<26)

    carry1 := (h1 + (1<<24)) >> 25
    h2 += int64(carry1)
    h1 -= int64(carry1) * (1<<25)
    carry5 := (h5 + (1<<24)) >> 25
    h6 += int64(carry5)
    h5 -= int64(carry5) * (1<<25)

    carry2 := (h2 + (1<<25)) >> 26
    h3 += int64(carry2)
    h2 -= int64(carry2) * (1<<26)
    carry6 := (h6 + (1<<25)) >> 26
    h7 += int64(carry6)
    h6 -= int64(carry6) * (1<<26)

    carry3 := (h3 + (1<<24)) >> 25
    h4 += int64(carry3)
    h3 -= int64(carry3) * (1<<25)
    carry7 := (h7 + (1<<24)) >> 25
    h8 += int64(carry7)
    h7 -= int64(carry7) * (1<<25)
    ...
    carry8 := (h8 + (1<<25)) >> 26
    h9 += int64(carry8)
    h8 -= int64(carry8) * (1<<26)

    carry9 := (h9 + (1<<24)) >> 25
    h0 += int64(carry9) * 19
    h9 -= int64(carry9) * (1<<25)
