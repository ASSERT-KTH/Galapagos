...
Concerning safety, in Go pointer usage and manual memory management is discouraged unless absolutely necessary. Hence, where possible environment it is recommended to use slice or array semantics without explicit denial reference indicators. That is:
