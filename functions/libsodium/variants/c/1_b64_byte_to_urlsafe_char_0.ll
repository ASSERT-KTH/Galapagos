; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/c/1_b64_byte_to_urlsafe_char_0.bc'
source_filename = "/home/javier/Galapagos/functions/libsodium/variants/c/1_b64_byte_to_urlsafe_char_0.c"
...
return:                                           ; preds = %if.end15, %if.then14, %if.then11, %if.then6, %if.then2, %if.then
