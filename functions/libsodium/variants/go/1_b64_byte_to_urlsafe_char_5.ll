; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/1_b64_byte_to_urlsafe_char_5.bc'
...
common.ret:                                       ; preds = %label.3, %else.2, %else.1, %else.0
  %common.ret.op = phi i32 [ %add.0, %else.0 ], [ %add.1, %else.1 ], [ %sub.0, %else.2 ], [ %switch.select24, %label.3 ]
