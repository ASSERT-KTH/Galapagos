; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_6.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:276>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_6.go:3\\n var product <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n { //6\\n  $ret0 = ((($convert(<type -8>, 2 ) * product) + x) + y) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 31C0606359C9CB9A4215F0C863DACF96207134F1\\n\22"
module asm "\09.text"
