; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_1.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_1.go:3\\n var xy <type -8> = (x & $convert(<type -8>, 4294967295 )) //5\\n xy = (xy * (y & $convert(<type -8>, 4294967295 ))) //6\\n { //7\\n  $ret0 = ((x + y) + (xy << $convert(<type -12>, 1 ))) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum FF64F41622287901AB9851EBAC592034E810979B\\n\22"
module asm "\09.text"
