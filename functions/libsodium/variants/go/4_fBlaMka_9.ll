; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_9.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_9.go:3\\n var prod <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n { //6\\n  $ret0 = ((($convert(<type -8>, 2 ) * prod) + x) + y) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 19C6DD18C0221B837CCB729F8959CF2F3D36EF11\\n\22"
module asm "\09.text"
