; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_2.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:315>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_2.go:3\\n var lowBits <type -8> = (x & $convert(<type -8>, 4294967295 )) //5\\n var combined <type -8> = (lowBits * (y & $convert(<type -8>, 4294967295 ))) //6\\n { //7\\n  $ret0 = ((x + y) + (combined * $convert(<type -8>, 2 ))) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 82B028232952C702206F8F9FB9492E4EBB4AADA6\\n\22"
module asm "\09.text"
