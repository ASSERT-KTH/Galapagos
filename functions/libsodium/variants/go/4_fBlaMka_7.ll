; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_7.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_7.go:3\\n var prod <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n { //6\\n  $ret0 = ((x + y) + ($convert(<type -8>, 2 ) * prod)) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 57B159258A62A0EB799358C6C56B9A5C54DCB6A4\\n\22"
module asm "\09.text"
