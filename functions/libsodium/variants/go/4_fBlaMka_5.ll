; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_5.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:307>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_5.go:3\\n var temp <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n var result <type -8> = ((x + y) + (temp << $convert(<type -12>, 1 ))) //6\\n { //7\\n  $ret0 = result //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum C6AA007C31A14A5AB271E66FBC02E655A6F8BA31\\n\22"
module asm "\09.text"
...
entry:
  ...
  %shl.0 = mul i64 %mul.0, %iand.1
  %add.1 = add i64 %add.0, %shl.0
  ret i64 %add.1
}
