; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_3.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_3.go:3\\n var partial <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n { //6\\n  $ret0 = ((x + y) + ($convert(<type -8>, 2 ) * partial)) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum CDDAE223100009ADF7D12B07066EE1A6ACBCB714\\n\22"
module asm "\09.text"
