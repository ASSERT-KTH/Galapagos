; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_0.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/4_fBlaMka_0.go:3\\n var xy <type -8> = ((x & $convert(<type -8>, 4294967295 )) * (y & $convert(<type -8>, 4294967295 ))) //5\\n { //6\\n  $ret0 = ((x + y) + ($convert(<type -8>, 2 ) * xy)) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 2D6AABB0B08C508435E8E8641391D0FDDDCE9FEC\\n\22"
module asm "\09.text"
