; ModuleID = '/home/javier/Galapagos/functions/libsodium/variants/go/0_b64_byte_to_char_5.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:1009>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libsodium/variants/go/0_b64_byte_to_char_5.go:3\\n { //4\\n  if (x < $convert(<type -7>, 26 )) { //4\\n   { //5\\n    $ret0 = ($convert(<type -3>, 65' ) + $convert(<type -3>, x)) //5\\n    return //5\\n   } //0\\n  } else { //6\\n   { //6\\n    if (x < $convert(<type -7>, 52 )) { //6\\n     { //7\\n      $ret0 = ($convert(<type -3>, 97' ) + $convert(<type -3>, (x - $convert(<type -7>, 26 )))) //7\\n      return //7\\n     } //0\\n    } else { //8\\n     { //8\\n      if (x < $convert(<type -7>, 62 )) { //8\\n       { //9\\n        $ret0 = ($convert(<type -3>, 48' ) + $convert(<type -3>, (x - $convert(<type -7>, 52 )))) //9\\n        return //9\\n       } //0\\n      } else { //10\\n       { //10\\n        if (x == $convert(<type -7>, 62 )) { //10\\n         { //11\\n          $ret0 = $convert(<type -3>, 43' ) //11\\n          return //11\\n         } //0\\n        } //10\\n       } //12\\n      } //8\\n     } //12\\n    } //6\\n   } //12\\n  } //4\\n } //12\\n { //13\\n  $ret0 = $convert(<type -3>, 47' ) //13\\n  return //13\\n } //0\\n\22"
module asm "\09.ascii \22checksum F05C50D427EB78A98535F63F34E9DB32E6D23DFF\\n\22"
module asm "\09.text"
