fe25519_sq(fe25519 h, const fe25519 f)
{
    ...
    new_carry  = (uint64_t) (r0 >> 51);
    r1    += new_carry;
    r01    = ((uint64_t) r1) & mask;
    new_carry  = (uint64_t) (r1 >> 51);
    r2    += new_carry;
    r02    = ((uint64_t) r2) & mask;
    carry_temp  = (uint64_t) (r2 >> 51);
    r3    += carry_temp;
    r03    = ((uint64_t) r3) & mask;
    carry_temp  = (uint64_t) (r3 >> 51);
    r4    += carry_temp;
    r04    = ((uint64_t) r4) & mask;
    carry_temp  = (uint64_t) (r4 >> 51);
    r00   += 19ULL * carry_temp;
    carrt_temp  = r00 >> 51;
    r00   &= mask;
    r01   += carry_temp;
    carry_temp  = r01 >> 51;
