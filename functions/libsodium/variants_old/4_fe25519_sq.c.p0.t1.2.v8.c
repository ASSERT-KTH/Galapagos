fe25519_sq(fe25519 h, const fe25519 f)
{
	...
	// the rest of calculations goes here maintaining similar transformation rules
	
}
This variant only change the readings of f indexes, instead of going from 0-9, they go from 9 to 0 and then we modify the how the same variables f0_2 for example to be clearly known its 2*f0 and not multiplying them.