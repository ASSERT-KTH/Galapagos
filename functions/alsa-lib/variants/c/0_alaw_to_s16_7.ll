; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_7.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_7.c"
...
entry:
  %call = call i32 @alaw_to_s16_v8(i8 noundef zeroext 97)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @alaw_to_s16_v8(i8 noundef zeroext %a_val) #0 {
entry:
...
cond.true:                                        ; preds = %entry
  ...
  %sub = sub nsw i32 %4, 1
  %shl5 = shl i32 256, %sub
  %add = add nsw i32 %shl5, 8
  br label %cond.end
...
cond.false11:                                     ; preds = %cond.end
  ...
  %sub12 = sub nsw i32 0, %8
  br label %cond.end13

cond.end13:                                       ; preds = %cond.false11, %cond.true10
  %cond14 = phi i32 [ %7, %cond.true10 ], [ %sub12, %cond.false11 ]
  ret i32 %cond14
}
