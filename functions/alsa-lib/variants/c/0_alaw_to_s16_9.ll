; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_9.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_9.c"
...
entry:
  %call = call i32 @alaw_to_s16_v10(i8 noundef zeroext 97)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @alaw_to_s16_v10(i8 noundef zeroext %a_val) #0 {
entry:
...
if.then:                                          ; preds = %cond.end
  ...
  %add4 = add nsw i32 %6, 256
  store i32 %add4, ptr %t, align 4
  br label %if.end
