; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/3_ulaw_to_s16_1.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/3_ulaw_to_s16_1.c"
...
entry:
  ...
  store i32 %and, ptr %sign, align 4
  %1 = load i8, ptr %u_val.addr, align 1
  %conv1 = zext i8 %1 to i32
  %not = xor i32 %conv1, -1
  %conv2 = trunc i32 %not to i8
  store i8 %conv2, ptr %u_val.addr, align 1
