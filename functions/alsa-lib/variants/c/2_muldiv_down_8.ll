; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_8.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_8.c"
...
entry:
  ...
  store i32 2147483647, ptr %maxInt, align 4
  store i32 -2147483648, ptr %minInt, align 4
  %3 = load i64, ptr %v, align 8
  %4 = load i32, ptr %maxInt, align 4
  %conv3 = sext i32 %4 to i64
  %cmp = icmp sgt i64 %3, %conv3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %5 = load i32, ptr %maxInt, align 4
  store i32 %5, ptr %retval, align 4
  br label %return

if.end:                                           ; preds = %entry
  %6 = load i64, ptr %v, align 8
  %7 = load i32, ptr %minInt, align 4
  %conv5 = sext i32 %7 to i64
  %cmp6 = icmp slt i64 %6, %conv5
  br i1 %cmp6, label %if.then8, label %if.end9

if.then8:                                         ; preds = %if.end
  %8 = load i32, ptr %minInt, align 4
