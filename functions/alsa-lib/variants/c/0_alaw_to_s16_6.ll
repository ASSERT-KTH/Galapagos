; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_6.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/0_alaw_to_s16_6.c"
...
entry:
  %call = call i32 @alaw_to_s16_v7(i8 noundef zeroext 97)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @alaw_to_s16_v7(i8 noundef zeroext %a_val) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %shl, %cond.true ], [ %shl4, %cond.false ]
  %and5 = and i32 %cond, 32767
  store i32 %and5, ptr %t, align 4
...
cond.end10:                                       ; preds = %cond.false9, %cond.true8
  %cond11 = phi i32 [ %7, %cond.true8 ], [ %sub, %cond.false9 ]
  ret i32 %cond11
}
