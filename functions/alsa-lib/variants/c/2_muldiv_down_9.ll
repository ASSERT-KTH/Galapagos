; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_9.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_9.c"
...
if.then:                                          ; preds = %entry
  store i64 2147483647, ptr %v, align 8
  br label %if.end7
...
if.then6:                                         ; preds = %if.else
  store i64 -2147483648, ptr %v, align 8
  br label %if.end
