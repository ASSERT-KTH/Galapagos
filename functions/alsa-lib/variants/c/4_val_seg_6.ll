; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/4_val_seg_6.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/4_val_seg_6.c"
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %add4 = add nsw i32 %5, %shr3
  store i32 %add4, ptr %r, align 4
  %6 = load i32, ptr %val.addr, align 4
  %and5 = and i32 %6, 2
  %shr6 = ashr i32 %and5, 1
  %7 = load i32, ptr %r, align 4
  %add7 = add nsw i32 %7, %shr6
  store i32 %add7, ptr %r, align 4
