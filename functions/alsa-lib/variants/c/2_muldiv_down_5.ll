; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_5.bc'
source_filename = "/home/javier/Galapagos/functions/alsa-lib/variants/c/2_muldiv_down_5.c"
...
cond.end:                                         ; preds = %cond.false7, %cond.true6
  %cond = phi i64 [ -2147483648, %cond.true6 ], [ %5, %cond.false7 ]
  br label %cond.end8

cond.end8:                                        ; preds = %cond.end, %cond.true
  %cond9 = phi i64 [ 2147483647, %cond.true ], [ %cond, %cond.end ]
  store i64 %cond9, ptr %v, align 8
