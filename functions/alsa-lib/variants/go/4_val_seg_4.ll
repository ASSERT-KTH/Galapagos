; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/4_val_seg_4.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:797>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/4_val_seg_4.go:3\\n var r <type -11> = 1  //4\\n val = (val >> $convert(<type -12>, 8 )) //5\\n { //6\\n  if (((val >> $convert(<type -12>, 4 )) & $convert(<type -3>, 15 )) != $convert(<type -3>, 0 )) { //6\\n   val = (val >> $convert(<type -12>, 4 )) //7\\n   r = (r + $convert(<type -11>, 4 )) //8\\n  } //6\\n } //9\\n { //10\\n  if (((val >> $convert(<type -12>, 2 )) & $convert(<type -3>, 3 )) != $convert(<type -3>, 0 )) { //10\\n   val = (val >> $convert(<type -12>, 2 )) //11\\n   r = (r + $convert(<type -11>, 2 )) //12\\n  } //10\\n } //13\\n { //14\\n  if (((val >> $convert(<type -12>, 1 )) & $convert(<type -3>, 1 )) != $convert(<type -3>, 0 )) { //14\\n   r = (r + $convert(<type -11>, 1 )) //15\\n  } //14\\n } //16\\n { //17\\n  $ret0 = r //17\\n  return //17\\n } //0\\n\22"
module asm "\09.ascii \22checksum E223F2EB28DD2F32FFB45375E4A60594F421ED96\\n\22"
module asm "\09.text"
...
entry:
  ...
  %spec.select12 = select i1 %icmp.0.not, i64 1, i64 5
  %1 = and i32 %spec.select, 12
  %icmp.1.not = icmp eq i32 %1, 0
  %2 = lshr i32 %spec.select, 2
  %add.1 = or i64 %spec.select12, 2
  %val.addr.1 = select i1 %icmp.1.not, i32 %spec.select, i32 %2
  %r.1 = select i1 %icmp.1.not, i64 %spec.select12, i64 %add.1
  %3 = lshr i32 %val.addr.1, 1
  %.lobit = and i32 %3, 1
  %4 = zext i32 %.lobit to i64
  %r.2 = add nuw nsw i64 %r.1, %4
  ret i64 %r.2
}
