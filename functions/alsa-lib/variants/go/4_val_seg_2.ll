...
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 5EB0F5CEC7B13061A1E4F63B36FB389E9C479B3B\\n\22"
module asm "\09.text"
...
entry:
  %icmp.13 = icmp eq ptr %key1, null
  br i1 %icmp.13, label %then.8, label %else.8, !make.implicit !3
...
then.8:                                           ; preds = %entry
  ...
  %icmp.14 = icmp eq ptr %key2, null
  br i1 %icmp.14, label %then.9, label %else.9, !make.implicit !3
...
then.9:                                           ; preds = %else.8
  ...
  %tmpv.9.sroa.0.0.cast.10.sroa_idx = bitcast ptr %key1 to ptr
  %tmpv.9.sroa.0.0.copyload = load i64, ptr %tmpv.9.sroa.0.0.cast.10.sroa_idx, align 8
  %tmpv.10.sroa.0.0.cast.15.sroa_idx = bitcast ptr %key2 to ptr
  %tmpv.10.sroa.0.0.copyload = load i64, ptr %tmpv.10.sroa.0.0.cast.15.sroa_idx, align 8
  %icmp.15.not = icmp eq i64 %tmpv.9.sroa.0.0.copyload, %tmpv.10.sroa.0.0.copyload
  br i1 %icmp.15.not, label %else.12, label %common.ret
...
common.ret:                                       ; preds = %else.12, %else.9
  ...
  %icmp.19.not = icmp eq i32 %.field.ld.0, %.field.ld.1
  %. = zext i1 %icmp.19.not to i8
  br label %common.ret
}
...
entry:
  ...
  %icmp.22 = icmp eq ptr %key1, null
  br i1 %icmp.22, label %then.16.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.25 = icmp eq ptr %key2, null
  br i1 %icmp.25, label %then.18.split, label %then.22, !make.implicit !3

label.0:                                          ; preds = %then.22
  %add.3 = add nuw nsw i64 %tmpv.23.018, 1
...
then.22:                                          ; preds = %label.0, %entry.split
  %tmpv.23.018 = phi i64 [ %add.3, %label.0 ], [ 0, %entry.split ]
  %tmpv.25.sroa.4.0.cast.24.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.23.018, i32 2
  %tmpv.25.sroa.4.0.copyload = load i64, ptr %tmpv.25.sroa.4.0.cast.24.sroa_idx7, align 8
  %tmpv.25.sroa.3.0.cast.24.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.23.018, i32 1
  %tmpv.25.sroa.3.0.copyload = load i64, ptr %tmpv.25.sroa.3.0.cast.24.sroa_idx6, align 8
  %tmpv.25.sroa.0.0.cast.24.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.23.018, i32 0
  %tmpv.25.sroa.0.0.copyload = load i32, ptr %tmpv.25.sroa.0.0.cast.24.sroa_idx, align 8
  %tmpv.26.sroa.0.0.cast.29.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.23.018, i32 0
  %tmpv.26.sroa.0.0.copyload = load i32, ptr %tmpv.26.sroa.0.0.cast.29.sroa_idx, align 8
  %tmpv.26.sroa.3.0.cast.29.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.23.018, i32 1
  %tmpv.26.sroa.3.0.copyload = load i64, ptr %tmpv.26.sroa.3.0.cast.29.sroa_idx4, align 8
  %tmpv.26.sroa.4.0.cast.29.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.23.018, i32 2
  %tmpv.26.sroa.4.0.copyload = load i64, ptr %tmpv.26.sroa.4.0.cast.29.sroa_idx5, align 8
  %icmp.26 = icmp eq i32 %tmpv.25.sroa.0.0.copyload, %tmpv.26.sroa.0.0.copyload
  %icmp.27 = icmp eq i64 %tmpv.25.sroa.3.0.copyload, %tmpv.26.sroa.3.0.copyload
  %tmpv.32.0.in = select i1 %icmp.26, i1 %icmp.27, i1 false
  %icmp.28 = icmp eq i64 %tmpv.25.sroa.4.0.copyload, %tmpv.26.sroa.4.0.copyload
  %tmpv.33.0.in = select i1 %tmpv.32.0.in, i1 %icmp.28, i1 false
...
entry:
  %icmp.31 = icmp eq ptr %key1, null
  br i1 %icmp.31, label %then.23, label %else.23, !make.implicit !3
...
then.23:                                          ; preds = %entry
  ...
  %icmp.32 = icmp eq ptr %key2, null
  br i1 %icmp.32, label %then.24, label %else.24, !make.implicit !3
...
then.24:                                          ; preds = %else.23
  ...
  %icmp.33.not = icmp eq i32 %.field.ld.2, %.field.ld.3
  br i1 %icmp.33.not, label %else.27, label %common.ret
...
common.ret:                                       ; preds = %else.30, %else.27, %else.24
  ...
  %icmp.36.not = icmp eq i64 %.field.ld.4, %.field.ld.5
  br i1 %icmp.36.not, label %else.30, label %common.ret
  ...
  %icmp.39.not = icmp eq i64 %.field.ld.6, %.field.ld.7
  %. = zext i1 %icmp.39.not to i8
  br label %common.ret
}
...
entry:
  ...
  br i1 %icmp.44, label %then.34.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.45 = icmp eq ptr %key2, null
  br i1 %icmp.45, label %then.35.split, label %then.37, !make.implicit !3

label.0:                                          ; preds = %then.37
  %add.4 = add nuw nsw i64 %tmpv.50.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.4.1 = add nuw nsw i64 %tmpv.50.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.4.2 = add nuw nsw i64 %tmpv.50.011, 3
...
then.37:                                          ; preds = %label.0.2, %entry.split
  %tmpv.50.011 = phi i64 [ %add.4.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], ptr %cast.40, i64 0, i64 %tmpv.50.011
  %.index.ld.0 = load double, ptr %index.2, align 8
  %index.3 = getelementptr [33 x double], ptr %cast.41, i64 0, i64 %tmpv.50.011
...
entry:
  ...
  %icmp.51 = icmp eq ptr %key1, null
  br i1 %icmp.51, label %then.40.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.52 = icmp eq ptr %key2, null
  br i1 %icmp.52, label %then.41.split, label %then.45, !make.implicit !3
...
then.42:                                          ; preds = %then.45
  %icmp.54 = icmp eq ptr %tmpv.66.sroa.0.0.copyload, %tmpv.68.sroa.0.0.copyload
  br i1 %icmp.54, label %else.44, label %fallthrough.42

fallthrough.42:                                   ; preds = %then.42
  %call.17 = call i32 @memcmp(ptr %tmpv.66.sroa.0.0.copyload, ptr %tmpv.68.sroa.0.0.copyload, i64 %tmpv.66.sroa.3.0.copyload)
  %icmp.55 = icmp eq i32 %call.17, 0
  br i1 %icmp.55, label %else.44, label %common.ret
...
common.ret:                                       ; preds = %then.45, %else.44, %fallthrough.42
  ...
  %add.5 = add nuw nsw i64 %tmpv.64.019, 1
  %exitcond.not = icmp eq i64 %add.5, 27
  br i1 %exitcond.not, label %common.ret, label %then.45

then.45:                                          ; preds = %else.44, %entry.split
  %tmpv.64.019 = phi i64 [ %add.5, %else.44 ], [ 0, %entry.split ]
  %tmpv.66.sroa.0.0.cast.48.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.64.019, i32 0
  %tmpv.66.sroa.0.0.copyload = load ptr, ptr %tmpv.66.sroa.0.0.cast.48.sroa_idx, align 8
  %tmpv.66.sroa.3.0.cast.48.sroa_idx3 = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.64.019, i32 1
  %tmpv.66.sroa.3.0.copyload = load i64, ptr %tmpv.66.sroa.3.0.cast.48.sroa_idx3, align 8
  %tmpv.68.sroa.0.0.cast.51.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.64.019, i32 0
  %tmpv.68.sroa.0.0.copyload = load ptr, ptr %tmpv.68.sroa.0.0.cast.51.sroa_idx, align 8
  %tmpv.68.sroa.3.0.cast.51.sroa_idx1 = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.64.019, i32 1
  %tmpv.68.sroa.3.0.copyload = load i64, ptr %tmpv.68.sroa.3.0.cast.51.sroa_idx1, align 8
  %icmp.53 = icmp eq i64 %tmpv.66.sroa.3.0.copyload, %tmpv.68.sroa.3.0.copyload
  br i1 %icmp.53, label %then.42, label %common.ret
}
