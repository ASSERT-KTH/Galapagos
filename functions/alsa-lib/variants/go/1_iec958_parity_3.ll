...
module asm "\09.ascii \22checksum 6BD1438C070A46F3D7AA1AE4A3B0C3856CC7C056\\n\22"
module asm "\09.text"
...
; Function Attrs: nofree norecurse nosync nounwind null_pointer_is_valid memory(none)
define i32 @main.iec958__parity(ptr nest nocapture readnone %nest.0, i32 %data) local_unnamed_addr #1 {
entry:
...
define void @main.main(ptr nest nocapture %nest.1) local_unnamed_addr #2 {
entry:
  ret void
}

; Function Attrs: noreturn null_pointer_is_valid
declare void @runtime.panicmem(ptr) local_unnamed_addr #3
...
then.10:                                          ; preds = %else.9
  ...
  %tmpv.10.sroa.0.0.cast.10.sroa_idx = bitcast ptr %key1 to ptr
  %tmpv.10.sroa.0.0.copyload = load i64, ptr %tmpv.10.sroa.0.0.cast.10.sroa_idx, align 8
  %tmpv.11.sroa.0.0.cast.15.sroa_idx = bitcast ptr %key2 to ptr
  %tmpv.11.sroa.0.0.copyload = load i64, ptr %tmpv.11.sroa.0.0.cast.15.sroa_idx, align 8
  %icmp.10.not = icmp eq i64 %tmpv.10.sroa.0.0.copyload, %tmpv.11.sroa.0.0.copyload
...
define i8 @main._632_7uintptr..eq(ptr nest nocapture readnone %nest.7, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6256_7uint64..eq(ptr nest nocapture readnone %nest.8, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
label.0:                                          ; preds = %then.23
  %add.2 = add nuw nsw i64 %tmpv.24.018, 1
...
then.23:                                          ; preds = %label.0, %entry.split
  %tmpv.24.018 = phi i64 [ %add.2, %label.0 ], [ 0, %entry.split ]
  %tmpv.26.sroa.4.0.cast.24.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.24.018, i32 2
  %tmpv.26.sroa.4.0.copyload = load i64, ptr %tmpv.26.sroa.4.0.cast.24.sroa_idx7, align 8
  %tmpv.26.sroa.3.0.cast.24.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.24.018, i32 1
  %tmpv.26.sroa.3.0.copyload = load i64, ptr %tmpv.26.sroa.3.0.cast.24.sroa_idx6, align 8
  %tmpv.26.sroa.0.0.cast.24.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.24.018, i32 0
  %tmpv.26.sroa.0.0.copyload = load i32, ptr %tmpv.26.sroa.0.0.cast.24.sroa_idx, align 8
  %tmpv.27.sroa.0.0.cast.29.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.24.018, i32 0
  %tmpv.27.sroa.0.0.copyload = load i32, ptr %tmpv.27.sroa.0.0.cast.29.sroa_idx, align 8
  %tmpv.27.sroa.3.0.cast.29.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.24.018, i32 1
  %tmpv.27.sroa.3.0.copyload = load i64, ptr %tmpv.27.sroa.3.0.cast.29.sroa_idx4, align 8
  %tmpv.27.sroa.4.0.cast.29.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.24.018, i32 2
  %tmpv.27.sroa.4.0.copyload = load i64, ptr %tmpv.27.sroa.4.0.cast.29.sroa_idx5, align 8
  %icmp.21 = icmp eq i32 %tmpv.26.sroa.0.0.copyload, %tmpv.27.sroa.0.0.copyload
  %icmp.22 = icmp eq i64 %tmpv.26.sroa.3.0.copyload, %tmpv.27.sroa.3.0.copyload
  %tmpv.33.0.in = select i1 %icmp.21, i1 %icmp.22, i1 false
  %icmp.23 = icmp eq i64 %tmpv.26.sroa.4.0.copyload, %tmpv.27.sroa.4.0.copyload
  %tmpv.34.0.in = select i1 %tmpv.33.0.in, i1 %icmp.23, i1 false
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6122_7uintptr..eq(ptr nest nocapture readnone %nest.11, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._68_7uint64..eq(ptr nest nocapture readnone %nest.12, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6128_7uint8..eq(ptr nest nocapture readnone %nest.13, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._64096_7uint8..eq(ptr nest nocapture readnone %nest.14, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._668_7uint16..eq(ptr nest nocapture readnone %nest.15, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
label.0:                                          ; preds = %then.38
  %add.3 = add nuw nsw i64 %tmpv.51.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.3.1 = add nuw nsw i64 %tmpv.51.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.3.2 = add nuw nsw i64 %tmpv.51.011, 3
...
then.38:                                          ; preds = %label.0.2, %entry.split
  %tmpv.51.011 = phi i64 [ %add.3.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], ptr %cast.40, i64 0, i64 %tmpv.51.011
  %.index.ld.0 = load double, ptr %index.2, align 8
  %index.3 = getelementptr [33 x double], ptr %cast.41, i64 0, i64 %tmpv.51.011
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._665_7uint32..eq(ptr nest nocapture readnone %nest.17, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._64_7uintptr..eq(ptr nest nocapture readnone %nest.18, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._65_7uint..eq(ptr nest nocapture readnone %nest.19, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6512_7uint8..eq(ptr nest nocapture readnone %nest.20, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6249_7uint8..eq(ptr nest nocapture readnone %nest.21, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6129_7uint8..eq(ptr nest nocapture readnone %nest.22, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._632_7uint8..eq(ptr nest nocapture readnone %nest.23, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
then.43:                                          ; preds = %then.46
  %icmp.49 = icmp eq ptr %tmpv.67.sroa.0.0.copyload, %tmpv.69.sroa.0.0.copyload
  br i1 %icmp.49, label %else.45, label %fallthrough.43

fallthrough.43:                                   ; preds = %then.43
  %call.17 = call i32 @memcmp(ptr %tmpv.67.sroa.0.0.copyload, ptr %tmpv.69.sroa.0.0.copyload, i64 %tmpv.67.sroa.3.0.copyload)
...
common.ret:                                       ; preds = %then.46, %else.45, %fallthrough.43
  ...
  %add.4 = add nuw nsw i64 %tmpv.65.019, 1
  %exitcond.not = icmp eq i64 %add.4, 27
  br i1 %exitcond.not, label %common.ret, label %then.46

then.46:                                          ; preds = %else.45, %entry.split
  %tmpv.65.019 = phi i64 [ %add.4, %else.45 ], [ 0, %entry.split ]
  %tmpv.67.sroa.0.0.cast.48.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.65.019, i32 0
  %tmpv.67.sroa.0.0.copyload = load ptr, ptr %tmpv.67.sroa.0.0.cast.48.sroa_idx, align 8
  %tmpv.67.sroa.3.0.cast.48.sroa_idx3 = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.65.019, i32 1
  %tmpv.67.sroa.3.0.copyload = load i64, ptr %tmpv.67.sroa.3.0.cast.48.sroa_idx3, align 8
  %tmpv.69.sroa.0.0.cast.51.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.65.019, i32 0
  %tmpv.69.sroa.0.0.copyload = load ptr, ptr %tmpv.69.sroa.0.0.cast.51.sroa_idx, align 8
  %tmpv.69.sroa.3.0.cast.51.sroa_idx1 = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.65.019, i32 1
  %tmpv.69.sroa.3.0.copyload = load i64, ptr %tmpv.69.sroa.3.0.cast.51.sroa_idx1, align 8
  %icmp.48 = icmp eq i64 %tmpv.67.sroa.3.0.copyload, %tmpv.69.sroa.3.0.copyload
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._61024_7uint8..eq(ptr nest nocapture readnone %nest.25, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._62_7int32..eq(ptr nest nocapture readnone %nest.26, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._664_7uint8..eq(ptr nest nocapture readnone %nest.27, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
; Function Attrs: nofree null_pointer_is_valid memory(read)
define i8 @main._6256_7uint8..eq(ptr nest nocapture readnone %nest.28, ptr readonly %key1, ptr readonly %key2) #4 {
entry:
...
attributes #1 = { nofree norecurse nosync nounwind null_pointer_is_valid memory(none) "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
attributes #2 = { mustprogress nofree norecurse nosync nounwind null_pointer_is_valid willreturn memory(none) "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
attributes #3 = { noreturn null_pointer_is_valid "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
attributes #4 = { nofree null_pointer_is_valid memory(read) "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
attributes #5 = { nofree null_pointer_is_valid memory(argmem: read) "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
attributes #6 = { mustprogress nofree nounwind null_pointer_is_valid willreturn memory(argmem: read) "disable-tail-calls"="true" "frame-pointer"="none" "split-stack" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" }
