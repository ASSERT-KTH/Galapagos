; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_4.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:585>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_4.go:3\\n data = (data >> $convert(<type -12>, 4 )) //4\\n var parity <type -7> = 0  //5\\n { //6\\n  var bit <type -11> = 4  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    parity = (parity ^ (data & $convert(<type -7>, 1 ))) //7\\n    data = (data >> $convert(<type -12>, 1 )) //8\\n   } //9\\n   { //6\\n    bit = (bit + $convert(<type -11>, 1 )) //6\\n   } //6\\n   :$l0 //6\\n   if (bit <= $convert(<type -11>, 30 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //9\\n { //10\\n  $ret0 = parity //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum EDEE07DEB94CD2E13C616721135D2A4FC32DB83C\\n\22"
module asm "\09.text"
...
label.0:                                          ; preds = %then.20
  %add.1 = add nuw nsw i64 %tmpv.22.018, 1
...
then.20:                                          ; preds = %label.0, %entry.split
  %tmpv.22.018 = phi i64 [ %add.1, %label.0 ], [ 0, %entry.split ]
...
label.0:                                          ; preds = %then.35
  %add.2 = add nuw nsw i64 %tmpv.49.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.2.1 = add nuw nsw i64 %tmpv.49.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.2.2 = add nuw nsw i64 %tmpv.49.011, 3
...
then.35:                                          ; preds = %label.0.2, %entry.split
  %tmpv.49.011 = phi i64 [ %add.2.2, %label.0.2 ], [ 0, %entry.split ]
