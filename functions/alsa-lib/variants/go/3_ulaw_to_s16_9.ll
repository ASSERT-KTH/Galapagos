; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_9.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_9.go:3\\n u_val = ^u_val //4\\n var t <type -3> = ((($convert(<type -3>, (u_val & $convert(<type -5>, 15 ))) << $convert(<type -12>, 3 )) | 132 ) << ((u_val & $convert(<type -5>, 112 )) >> $convert(<type -12>, 4 ))) //6\\n { //8\\n  if ((u_val & $convert(<type -5>, 128 )) != $convert(<type -5>, 0 )) { //8\\n   { //9\\n    $ret0 = ($convert(<type -3>, 132 ) - t) //9\\n    return //9\\n   } //0\\n  } //8\\n } //10\\n { //11\\n  $ret0 = (t - $convert(<type -3>, 132 )) //11\\n  return //11\\n } //0\\n\22"
module asm "\09.ascii \22checksum 6F55E858B37275FA1C71D2A1B02B01DBA829F70A\\n\22"
module asm "\09.text"
