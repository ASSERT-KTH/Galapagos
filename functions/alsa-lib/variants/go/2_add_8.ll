; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_8.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_8.go:3\\n { //4\\n  if (a > ($convert(<type -7>, 4294967295 ) - b)) { //4\\n   { //5\\n    $ret0 = $convert(<type -7>, 4294967295 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = (a + b) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 88C108A6D26F17AD8436072A5DE90FC40CEEE8ED\\n\22"
module asm "\09.text"
