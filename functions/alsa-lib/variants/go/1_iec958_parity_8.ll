; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_8.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:708>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_8.go:3\\n data = (data >> $convert(<type -12>, 4 )) //4\\n var parity <type -7> = 0  //5\\n { //6\\n  var i <type -11> = 4  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    { //7\\n     if ((data & $convert(<type -7>, 1 )) != $convert(<type -7>, 0 )) { //7\\n      parity = (parity + $convert(<type -7>, 1 )) //8\\n     } //7\\n    } //9\\n    data = (data >> $convert(<type -12>, 1 )) //10\\n   } //11\\n   { //6\\n    i = (i + $convert(<type -11>, 1 )) //6\\n   } //6\\n   :$l0 //6\\n   if (i <= $convert(<type -11>, 30 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //11\\n { //12\\n  $ret0 = (parity & $convert(<type -7>, 1 )) //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum 90FA0F5F3184BB95C620CB9CC964F5FA2E0992B0\\n\22"
module asm "\09.text"
