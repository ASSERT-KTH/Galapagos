; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_6.bc'
...
label.0:                                          ; preds = %then.21
  %add.1 = add nuw nsw i64 %tmpv.27.018, 1
...
then.21:                                          ; preds = %label.0, %entry.split
  %tmpv.27.018 = phi i64 [ %add.1, %label.0 ], [ 0, %entry.split ]
...
label.0:                                          ; preds = %then.36
  %add.2 = add nuw nsw i64 %tmpv.54.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.2.1 = add nuw nsw i64 %tmpv.54.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.2.2 = add nuw nsw i64 %tmpv.54.011, 3
...
then.36:                                          ; preds = %label.0.2, %entry.split
  %tmpv.54.011 = phi i64 [ %add.2.2, %label.0.2 ], [ 0, %entry.split ]
