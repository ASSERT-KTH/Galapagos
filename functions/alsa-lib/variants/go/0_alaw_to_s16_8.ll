; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_8.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:757>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_8.go:3\\n aVal = (aVal ^ $convert(<type -20>, 85 )) //4\\n var t <type -3> = $convert(<type -3>, (aVal & $convert(<type -20>, 127 ))) //5\\n { //6\\n  if (t < $convert(<type -3>, 16 )) { //6\\n   t = ((t * $convert(<type -3>, 16 )) + $convert(<type -3>, 8 )) //7\\n  } else { //8\\n   var seg <type -3> = ((t / 16 ) & 7 ) //9\\n   t = ($convert(<type -3>, 264 ) + ((t % $convert(<type -3>, 16 )) * $convert(<type -3>, 16 ))) //10\\n   t = (t << (seg - $convert(<type -3>, 1 ))) //11\\n  } //6\\n } //12\\n { //13\\n  if ((aVal & $convert(<type -20>, 128 )) != $convert(<type -20>, 0 )) { //13\\n   { //14\\n    $ret0 = t //14\\n    return //14\\n   } //0\\n  } //13\\n } //15\\n { //16\\n  $ret0 = -t //16\\n  return //16\\n } //0\\n\22"
module asm "\09.ascii \22checksum 36B605930067A5EFD5E39F3261D742785A264FAB\\n\22"
module asm "\09.text"
...
then.14:                                          ; preds = %else.13
  ...
  %tmpv.15.sroa.0.0.cast.10.sroa_idx = bitcast ptr %key1 to ptr
  %tmpv.15.sroa.0.0.copyload = load i64, ptr %tmpv.15.sroa.0.0.cast.10.sroa_idx, align 8
  %tmpv.16.sroa.0.0.cast.15.sroa_idx = bitcast ptr %key2 to ptr
  %tmpv.16.sroa.0.0.copyload = load i64, ptr %tmpv.16.sroa.0.0.cast.15.sroa_idx, align 8
  %icmp.14.not = icmp eq i64 %tmpv.15.sroa.0.0.copyload, %tmpv.16.sroa.0.0.copyload
...
label.0:                                          ; preds = %then.27
  %add.2 = add nuw nsw i64 %tmpv.29.018, 1
...
then.27:                                          ; preds = %label.0, %entry.split
  %tmpv.29.018 = phi i64 [ %add.2, %label.0 ], [ 0, %entry.split ]
  %tmpv.31.sroa.4.0.cast.24.sroa_idx7 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.29.018, i32 2
  %tmpv.31.sroa.4.0.copyload = load i64, ptr %tmpv.31.sroa.4.0.cast.24.sroa_idx7, align 8
  %tmpv.31.sroa.3.0.cast.24.sroa_idx6 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.29.018, i32 1
  %tmpv.31.sroa.3.0.copyload = load i64, ptr %tmpv.31.sroa.3.0.cast.24.sroa_idx6, align 8
  %tmpv.31.sroa.0.0.cast.24.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.20, i64 0, i64 %tmpv.29.018, i32 0
  %tmpv.31.sroa.0.0.copyload = load i32, ptr %tmpv.31.sroa.0.0.cast.24.sroa_idx, align 8
  %tmpv.32.sroa.0.0.cast.29.sroa_idx = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.29.018, i32 0
  %tmpv.32.sroa.0.0.copyload = load i32, ptr %tmpv.32.sroa.0.0.cast.29.sroa_idx, align 8
  %tmpv.32.sroa.3.0.cast.29.sroa_idx4 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.29.018, i32 1
  %tmpv.32.sroa.3.0.copyload = load i64, ptr %tmpv.32.sroa.3.0.cast.29.sroa_idx4, align 8
  %tmpv.32.sroa.4.0.cast.29.sroa_idx5 = getelementptr [61 x { i32, i64, i64 }], ptr %cast.21, i64 0, i64 %tmpv.29.018, i32 2
  %tmpv.32.sroa.4.0.copyload = load i64, ptr %tmpv.32.sroa.4.0.cast.29.sroa_idx5, align 8
  %icmp.25 = icmp eq i32 %tmpv.31.sroa.0.0.copyload, %tmpv.32.sroa.0.0.copyload
  %icmp.26 = icmp eq i64 %tmpv.31.sroa.3.0.copyload, %tmpv.32.sroa.3.0.copyload
  %tmpv.38.0.in = select i1 %icmp.25, i1 %icmp.26, i1 false
  %icmp.27 = icmp eq i64 %tmpv.31.sroa.4.0.copyload, %tmpv.32.sroa.4.0.copyload
  %tmpv.39.0.in = select i1 %tmpv.38.0.in, i1 %icmp.27, i1 false
  br i1 %tmpv.39.0.in, label %label.0, label %common.ret
}
...
label.0:                                          ; preds = %then.42
  %add.3 = add nuw nsw i64 %tmpv.56.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.3.1 = add nuw nsw i64 %tmpv.56.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.3.2 = add nuw nsw i64 %tmpv.56.011, 3
...
then.42:                                          ; preds = %label.0.2, %entry.split
  %tmpv.56.011 = phi i64 [ %add.3.2, %label.0.2 ], [ 0, %entry.split ]
  %index.2 = getelementptr [33 x double], ptr %cast.40, i64 0, i64 %tmpv.56.011
  %.index.ld.0 = load double, ptr %index.2, align 8
  %index.3 = getelementptr [33 x double], ptr %cast.41, i64 0, i64 %tmpv.56.011
...
then.47:                                          ; preds = %then.50
  %icmp.53 = icmp eq ptr %tmpv.72.sroa.0.0.copyload, %tmpv.74.sroa.0.0.copyload
  br i1 %icmp.53, label %else.49, label %fallthrough.47

fallthrough.47:                                   ; preds = %then.47
  %call.17 = call i32 @memcmp(ptr %tmpv.72.sroa.0.0.copyload, ptr %tmpv.74.sroa.0.0.copyload, i64 %tmpv.72.sroa.3.0.copyload)
  %icmp.54 = icmp eq i32 %call.17, 0
...
common.ret:                                       ; preds = %then.50, %else.49, %fallthrough.47
  ...
  %add.4 = add nuw nsw i64 %tmpv.70.019, 1
  %exitcond.not = icmp eq i64 %add.4, 27
  br i1 %exitcond.not, label %common.ret, label %then.50

then.50:                                          ; preds = %else.49, %entry.split
  %tmpv.70.019 = phi i64 [ %add.4, %else.49 ], [ 0, %entry.split ]
  %tmpv.72.sroa.0.0.cast.48.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.70.019, i32 0
  %tmpv.72.sroa.0.0.copyload = load ptr, ptr %tmpv.72.sroa.0.0.cast.48.sroa_idx, align 8
  %tmpv.72.sroa.3.0.cast.48.sroa_idx3 = getelementptr [27 x { ptr, i64 }], ptr %cast.44, i64 0, i64 %tmpv.70.019, i32 1
  %tmpv.72.sroa.3.0.copyload = load i64, ptr %tmpv.72.sroa.3.0.cast.48.sroa_idx3, align 8
  %tmpv.74.sroa.0.0.cast.51.sroa_idx = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.70.019, i32 0
  %tmpv.74.sroa.0.0.copyload = load ptr, ptr %tmpv.74.sroa.0.0.cast.51.sroa_idx, align 8
  %tmpv.74.sroa.3.0.cast.51.sroa_idx1 = getelementptr [27 x { ptr, i64 }], ptr %cast.45, i64 0, i64 %tmpv.70.019, i32 1
  %tmpv.74.sroa.3.0.copyload = load i64, ptr %tmpv.74.sroa.3.0.cast.51.sroa_idx1, align 8
  %icmp.52 = icmp eq i64 %tmpv.72.sroa.3.0.copyload, %tmpv.74.sroa.3.0.copyload
