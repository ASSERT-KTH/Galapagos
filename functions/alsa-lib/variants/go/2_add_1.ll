; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_1.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_1.go:3\\n var max <type -7> = 4294967295  //4\\n var sum <type -7> = (a + b) //5\\n { //6\\n  if ((sum < a) || (sum < b)) { //6\\n   { //7\\n    $ret0 = max //7\\n    return //7\\n   } //0\\n  } //6\\n } //8\\n { //9\\n  $ret0 = sum //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 8DF1C9B3BEA59D19F5112C01ADB3043BCD782689\\n\22"
module asm "\09.text"
...
entry:
  %add.0 = add i32 %b, %a
  %icmp.0 = icmp ult i32 %add.0, %a
  %icmp.1 = icmp ult i32 %add.0, %b
  %spec.select = or i1 %icmp.0, %icmp.1
  %common.ret.op = select i1 %spec.select, i32 -1, i32 %add.0
...
entry:
  ...
  br i1 %icmp.7, label %then.7, label %else.7, !make.implicit !3
...
then.8:                                           ; preds = %else.7
  ...
  %icmp.9.not = icmp eq i64 %tmpv.9.sroa.0.0.copyload, %tmpv.10.sroa.0.0.copyload
  br i1 %icmp.9.not, label %else.11, label %common.ret
...
entry:
  ...
  br i1 %icmp.16, label %then.15.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.19 = icmp eq ptr %key2, null
  br i1 %icmp.19, label %then.17.split, label %then.21, !make.implicit !3

label.0:                                          ; preds = %then.21
  %add.1 = add nuw nsw i64 %tmpv.23.018, 1
...
then.21:                                          ; preds = %label.0, %entry.split
  %tmpv.23.018 = phi i64 [ %add.1, %label.0 ], [ 0, %entry.split ]
  ...
  %icmp.20 = icmp eq i32 %tmpv.25.sroa.0.0.copyload, %tmpv.26.sroa.0.0.copyload
  %icmp.21 = icmp eq i64 %tmpv.25.sroa.3.0.copyload, %tmpv.26.sroa.3.0.copyload
  %tmpv.32.0.in = select i1 %icmp.20, i1 %icmp.21, i1 false
  %icmp.22 = icmp eq i64 %tmpv.25.sroa.4.0.copyload, %tmpv.26.sroa.4.0.copyload
  %tmpv.33.0.in = select i1 %tmpv.32.0.in, i1 %icmp.22, i1 false
...
entry:
  ...
  br i1 %icmp.25, label %then.22, label %else.22, !make.implicit !3
...
then.22:                                          ; preds = %entry
  ...
  br i1 %icmp.26, label %then.23, label %else.23, !make.implicit !3
...
then.23:                                          ; preds = %else.22
  ...
  br i1 %icmp.27.not, label %else.26, label %common.ret
...
common.ret:                                       ; preds = %else.29, %else.26, %else.23
  ...
  br i1 %icmp.30.not, label %else.29, label %common.ret
...
entry:
  ...
  br i1 %icmp.38, label %then.33.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.39 = icmp eq ptr %key2, null
  br i1 %icmp.39, label %then.34.split, label %then.36, !make.implicit !3

label.0:                                          ; preds = %then.36
  %add.2 = add nuw nsw i64 %tmpv.50.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.2.1 = add nuw nsw i64 %tmpv.50.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.2.2 = add nuw nsw i64 %tmpv.50.011, 3
...
then.36:                                          ; preds = %label.0.2, %entry.split
  %tmpv.50.011 = phi i64 [ %add.2.2, %label.0.2 ], [ 0, %entry.split ]
...
entry:
  ...
  br i1 %icmp.45, label %then.39.split, label %entry.split, !make.implicit !3

entry.split:                                      ; preds = %entry
  %icmp.46 = icmp eq ptr %key2, null
  br i1 %icmp.46, label %then.40.split, label %then.44, !make.implicit !3
...
then.41:                                          ; preds = %then.44
  %icmp.48 = icmp eq ptr %tmpv.66.sroa.0.0.copyload, %tmpv.68.sroa.0.0.copyload
  br i1 %icmp.48, label %else.43, label %fallthrough.41
...
fallthrough.41:                                   ; preds = %then.41
  ...
  br i1 %icmp.49, label %else.43, label %common.ret
...
then.44:                                          ; preds = %else.43, %entry.split
  ...
  %icmp.47 = icmp eq i64 %tmpv.66.sroa.3.0.copyload, %tmpv.68.sroa.3.0.copyload
  br i1 %icmp.47, label %then.41, label %common.ret
}
