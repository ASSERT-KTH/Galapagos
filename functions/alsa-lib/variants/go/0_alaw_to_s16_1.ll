; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_1.bc'
...
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 1AE4A8C4B480926A797F12DCB47DEB53B6699D3B\\n\22"
module asm "\09.text"
...
then.10:                                          ; preds = %else.9
  ...
  %icmp.12.not = icmp eq i64 %tmpv.13.sroa.0.0.copyload, %tmpv.14.sroa.0.0.copyload
...
then.23:                                          ; preds = %label.0, %entry.split
  %tmpv.27.018 = phi i64 [ %add.2, %label.0 ], [ 0, %entry.split ]
  ...
  %icmp.23 = icmp eq i32 %tmpv.29.sroa.0.0.copyload, %tmpv.30.sroa.0.0.copyload
  %icmp.24 = icmp eq i64 %tmpv.29.sroa.3.0.copyload, %tmpv.30.sroa.3.0.copyload
  %tmpv.36.0.in = select i1 %icmp.23, i1 %icmp.24, i1 false
  %icmp.25 = icmp eq i64 %tmpv.29.sroa.4.0.copyload, %tmpv.30.sroa.4.0.copyload
  %tmpv.37.0.in = select i1 %tmpv.36.0.in, i1 %icmp.25, i1 false
...
label.0.1:                                        ; preds = %label.0
  %add.3.1 = add nuw nsw i64 %tmpv.54.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.3.2 = add nuw nsw i64 %tmpv.54.011, 3
...
then.38:                                          ; preds = %label.0.2, %entry.split
  %tmpv.54.011 = phi i64 [ %add.3.2, %label.0.2 ], [ 0, %entry.split ]
...
then.43:                                          ; preds = %then.46
  %icmp.51 = icmp eq ptr %tmpv.70.sroa.0.0.copyload, %tmpv.72.sroa.0.0.copyload
...
then.46:                                          ; preds = %else.45, %entry.split
  ...
  %icmp.50 = icmp eq i64 %tmpv.70.sroa.3.0.copyload, %tmpv.72.sroa.3.0.copyload
