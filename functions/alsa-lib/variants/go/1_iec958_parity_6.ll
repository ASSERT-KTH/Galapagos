; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_6.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:604>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_6.go:3\\n data = (data >> $convert(<type -12>, 4 )) //4\\n var parity <type -7> = 0  //5\\n { //6\\n  var i <type -11> = 0  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    parity = (parity + (data & $convert(<type -7>, 1 ))) //7\\n    data = (data >> $convert(<type -12>, 1 )) //8\\n   } //9\\n   { //6\\n    i = (i + $convert(<type -11>, 1 )) //6\\n   } //6\\n   :$l0 //6\\n   if (i < $convert(<type -11>, 27 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //9\\n { //10\\n  $ret0 = (parity & $convert(<type -7>, 1 )) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum A3A4680ABE7801E7281E4037385B381B6305E9F2\\n\22"
module asm "\09.text"
