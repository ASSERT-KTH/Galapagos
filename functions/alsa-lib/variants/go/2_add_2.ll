; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_2.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:280>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_2.go:3\\n { //4\\n  if (a > ($convert(<type -7>, 4294967295 ) - b)) { //4\\n   { //5\\n    $ret0 = $convert(<type -7>, 4294967295 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = (a + b) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum DF5C3D8FC7782B0CAB9B812D936AB1DDFEF7CDA6\\n\22"
module asm "\09.text"
...
entry:
  %0 = call i32 @llvm.uadd.sat.i32(i32 %b, i32 %a)
  ret i32 %0
}
