; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_9.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:516>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_9.go:3\\n data = (data >> $convert(<type -12>, 4 )) //4\\n var parity <type -7> = 0  //5\\n { //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    parity = (parity ^ (data & $convert(<type -7>, 1 ))) //7\\n    data = (data >> $convert(<type -12>, 1 )) //8\\n   } //9\\n   :$l0 //6\\n   if (data > $convert(<type -7>, 0 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //9\\n } //9\\n { //10\\n  $ret0 = (parity & $convert(<type -7>, 1 )) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 7D45B89702BB72E43EAD43EB71D9A20F71FE274B\\n\22"
module asm "\09.text"
...
label.0:                                          ; preds = %then.20
  %add.0 = add nuw nsw i64 %tmpv.22.018, 1
...
then.20:                                          ; preds = %label.0, %entry.split
  %tmpv.22.018 = phi i64 [ %add.0, %label.0 ], [ 0, %entry.split ]
...
label.0:                                          ; preds = %then.35
  %add.1 = add nuw nsw i64 %tmpv.49.011, 1
  %index.2.1 = getelementptr [33 x double], ptr %cast.40, i64 0, i64 %add.1
  %.index.ld.0.1 = load double, ptr %index.2.1, align 8
  %index.3.1 = getelementptr [33 x double], ptr %cast.41, i64 0, i64 %add.1
...
label.0.1:                                        ; preds = %label.0
  %add.1.1 = add nuw nsw i64 %tmpv.49.011, 2
  %index.2.2 = getelementptr [33 x double], ptr %cast.40, i64 0, i64 %add.1.1
  %.index.ld.0.2 = load double, ptr %index.2.2, align 8
  %index.3.2 = getelementptr [33 x double], ptr %cast.41, i64 0, i64 %add.1.1
...
label.0.2:                                        ; preds = %label.0.1
  %add.1.2 = add nuw nsw i64 %tmpv.49.011, 3
...
then.35:                                          ; preds = %label.0.2, %entry.split
  %tmpv.49.011 = phi i64 [ %add.1.2, %label.0.2 ], [ 0, %entry.split ]
