...
module asm "\09.ascii \22checksum 1AB249517149EBEB2AC7C23000645D46EFB41C4A\\n\22"
module asm "\09.text"
...
then.8:                                           ; preds = %else.7
  ...
  %icmp.8.not = icmp eq i64 %tmpv.12.sroa.0.0.copyload, %tmpv.13.sroa.0.0.copyload
...
label.0:                                          ; preds = %then.21
  %add.1 = add nuw nsw i64 %tmpv.26.018, 1
...
then.21:                                          ; preds = %label.0, %entry.split
  %tmpv.26.018 = phi i64 [ %add.1, %label.0 ], [ 0, %entry.split ]
  ...
  %icmp.19 = icmp eq i32 %tmpv.28.sroa.0.0.copyload, %tmpv.29.sroa.0.0.copyload
  %icmp.20 = icmp eq i64 %tmpv.28.sroa.3.0.copyload, %tmpv.29.sroa.3.0.copyload
  %tmpv.35.0.in = select i1 %icmp.19, i1 %icmp.20, i1 false
  %icmp.21 = icmp eq i64 %tmpv.28.sroa.4.0.copyload, %tmpv.29.sroa.4.0.copyload
  %tmpv.36.0.in = select i1 %tmpv.35.0.in, i1 %icmp.21, i1 false
...
label.0:                                          ; preds = %then.36
  %add.2 = add nuw nsw i64 %tmpv.53.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.2.1 = add nuw nsw i64 %tmpv.53.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.2.2 = add nuw nsw i64 %tmpv.53.011, 3
...
then.36:                                          ; preds = %label.0.2, %entry.split
  %tmpv.53.011 = phi i64 [ %add.2.2, %label.0.2 ], [ 0, %entry.split ]
...
then.41:                                          ; preds = %then.44
  %icmp.47 = icmp eq ptr %tmpv.69.sroa.0.0.copyload, %tmpv.71.sroa.0.0.copyload
...
then.44:                                          ; preds = %else.43, %entry.split
  ...
  %icmp.46 = icmp eq i64 %tmpv.69.sroa.3.0.copyload, %tmpv.71.sroa.3.0.copyload
