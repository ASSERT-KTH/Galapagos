; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_5.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/2_add_5.go:3\\n var maxUint <type -7> = 4294967295  //4\\n var c <type -7> = (a + b) //5\\n { //6\\n  if (c > maxUint) { //6\\n   { //7\\n    $ret0 = maxUint //7\\n    return //7\\n   } //0\\n  } //6\\n } //8\\n { //9\\n  if (c < a) { //9\\n   { //10\\n    $ret0 = maxUint //10\\n    return //10\\n   } //0\\n  } //9\\n } //11\\n { //12\\n  $ret0 = c //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum 1DBBC8B7AD247FFB4069E37FE0F50E9F0781FF33\\n\22"
module asm "\09.text"
...
then.44:                                          ; preds = %else.43, %entry.split
  %tmpv.63.019 = phi i64 [ %add.3, %else.43 ], [ 0, %entry.split ]
