; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_8.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:579>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_8.go:3\\n u_val = ^u_val //4\\n var q <type -3> = (($convert(<type -3>, (u_val & $convert(<type -5>, 15 ))) << $convert(<type -12>, 3 )) + 132 ) //6\\n var s <type -5> = ((u_val & 112 ) >> $convert(<type -12>, 4 )) //7\\n var t <type -3> = (q << s) //8\\n { //10\\n  if ((u_val & $convert(<type -5>, 128 )) != $convert(<type -5>, 0 )) { //10\\n   { //11\\n    $ret0 = ($convert(<type -3>, 132 ) - t) //11\\n    return //11\\n   } //0\\n  } //10\\n } //12\\n { //13\\n  $ret0 = (t - $convert(<type -3>, 132 )) //13\\n  return //13\\n } //0\\n\22"
module asm "\09.ascii \22checksum CBA23DBFBEA85A8B1DD3A3B83889C9AABE848EC4\\n\22"
module asm "\09.text"
