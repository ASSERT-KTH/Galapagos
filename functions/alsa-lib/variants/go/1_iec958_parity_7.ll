; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_7.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:707>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/1_iec958_parity_7.go:3\\n data = (data >> $convert(<type -12>, 4 )) //4\\n var parity <type -7> = 0  //5\\n { //6\\n  var i <type -11> = 0  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    { //7\\n     if ((data & $convert(<type -7>, 1 )) != $convert(<type -7>, 0 )) { //7\\n      parity = (parity + $convert(<type -7>, 1 )) //8\\n     } //7\\n    } //9\\n    data = (data >> $convert(<type -12>, 1 )) //10\\n   } //11\\n   { //6\\n    i = (i + $convert(<type -11>, 1 )) //6\\n   } //6\\n   :$l0 //6\\n   if (i < $convert(<type -11>, 27 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //11\\n { //12\\n  $ret0 = (parity & $convert(<type -7>, 1 )) //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum DAB0E991DE15153433A9A96235D3CABB91825D11\\n\22"
module asm "\09.text"
...
then.8:                                           ; preds = %else.7
  ...
  %icmp.8.not = icmp eq i64 %tmpv.8.sroa.0.0.copyload, %tmpv.9.sroa.0.0.copyload
...
then.21:                                          ; preds = %label.0, %entry.split
  ...
  %icmp.19 = icmp eq i32 %tmpv.24.sroa.0.0.copyload, %tmpv.25.sroa.0.0.copyload
  %icmp.20 = icmp eq i64 %tmpv.24.sroa.3.0.copyload, %tmpv.25.sroa.3.0.copyload
  %tmpv.31.0.in = select i1 %icmp.19, i1 %icmp.20, i1 false
  %icmp.21 = icmp eq i64 %tmpv.24.sroa.4.0.copyload, %tmpv.25.sroa.4.0.copyload
  %tmpv.32.0.in = select i1 %tmpv.31.0.in, i1 %icmp.21, i1 false
...
then.41:                                          ; preds = %then.44
  %icmp.47 = icmp eq ptr %tmpv.65.sroa.0.0.copyload, %tmpv.67.sroa.0.0.copyload
...
then.44:                                          ; preds = %else.43, %entry.split
  %tmpv.63.019 = phi i64 [ %add.4, %else.43 ], [ 0, %entry.split ]
  ...
  %icmp.46 = icmp eq i64 %tmpv.65.sroa.3.0.copyload, %tmpv.67.sroa.3.0.copyload
