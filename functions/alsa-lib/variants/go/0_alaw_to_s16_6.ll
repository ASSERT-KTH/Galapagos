; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_6.bc'
...
fallthrough.0:                                    ; preds = %else.0, %then.0
  %t.0 = phi i32 [ %add.0, %then.0 ], [ %sub.0, %else.0 ]
  %icmp.3.not = icmp sgt i8 %aVal, -1
  %sub.1 = sub nsw i32 0, %t.0
  ...
  %shl.2 = shl i32 %add.1, %0
  %sub.0 = add nsw i32 %shl.2, -1
  br label %fallthrough.0
}
...
then.10:                                          ; preds = %else.9
  ...
  %icmp.10.not = icmp eq i64 %tmpv.11.sroa.0.0.copyload, %tmpv.12.sroa.0.0.copyload
...
label.0:                                          ; preds = %then.23
  %add.2 = add nuw nsw i64 %tmpv.25.018, 1
...
then.23:                                          ; preds = %label.0, %entry.split
  %tmpv.25.018 = phi i64 [ %add.2, %label.0 ], [ 0, %entry.split ]
  ...
  %icmp.21 = icmp eq i32 %tmpv.27.sroa.0.0.copyload, %tmpv.28.sroa.0.0.copyload
  %icmp.22 = icmp eq i64 %tmpv.27.sroa.3.0.copyload, %tmpv.28.sroa.3.0.copyload
  %tmpv.34.0.in = select i1 %icmp.21, i1 %icmp.22, i1 false
  %icmp.23 = icmp eq i64 %tmpv.27.sroa.4.0.copyload, %tmpv.28.sroa.4.0.copyload
  %tmpv.35.0.in = select i1 %tmpv.34.0.in, i1 %icmp.23, i1 false
...
label.0:                                          ; preds = %then.38
  %add.3 = add nuw nsw i64 %tmpv.52.011, 1
...
label.0.1:                                        ; preds = %label.0
  %add.3.1 = add nuw nsw i64 %tmpv.52.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.3.2 = add nuw nsw i64 %tmpv.52.011, 3
...
then.38:                                          ; preds = %label.0.2, %entry.split
  %tmpv.52.011 = phi i64 [ %add.3.2, %label.0.2 ], [ 0, %entry.split ]
...
then.43:                                          ; preds = %then.46
  %icmp.49 = icmp eq ptr %tmpv.68.sroa.0.0.copyload, %tmpv.70.sroa.0.0.copyload
...
then.46:                                          ; preds = %else.45, %entry.split
  ...
  %icmp.48 = icmp eq i64 %tmpv.68.sroa.3.0.copyload, %tmpv.70.sroa.3.0.copyload
