; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_3.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:619>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/3_ulaw_to_s16_3.go:3\\n u_val = ^u_val //4\\n var quantization_bits <type -3> = (($convert(<type -3>, (u_val & $convert(<type -5>, 15 ))) << $convert(<type -12>, 3 )) + 132 ) //6\\n var shift <type -5> = ((u_val & 112 ) >> $convert(<type -12>, 4 )) //7\\n var t <type -3> = (quantization_bits << shift) //8\\n { //10\\n  if ((u_val & $convert(<type -5>, 128 )) != $convert(<type -5>, 0 )) { //10\\n   { //11\\n    $ret0 = ($convert(<type -3>, 132 ) - t) //11\\n    return //11\\n   } //0\\n  } //10\\n } //12\\n { //14\\n  $ret0 = (t - $convert(<type -3>, 132 )) //14\\n  return //14\\n } //0\\n\22"
module asm "\09.ascii \22checksum 6C9A4A75B299FD1794C9745B430D2323EAAB988F\\n\22"
module asm "\09.text"
