; ModuleID = '/home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_4.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:702>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/alsa-lib/variants/go/0_alaw_to_s16_4.go:3\\n aVal = (aVal ^ $convert(<type -20>, 85 )) //4\\n var t <type -3> = ($convert(<type -3>, (aVal & $convert(<type -20>, 127 ))) * 8 ) //5\\n { //6\\n  if (t < $convert(<type -3>, 128 )) { //6\\n   t = (t + $convert(<type -3>, 8 )) //7\\n  } else { //8\\n   var seg <type -3> = ((t >> $convert(<type -12>, 7 )) & 7 ) //9\\n   t = ((t & $convert(<type -3>, 127 )) + $convert(<type -3>, 264 )) //10\\n   t = (t << seg) //11\\n  } //6\\n } //12\\n { //13\\n  if ((aVal & $convert(<type -20>, 128 )) != $convert(<type -20>, 0 )) { //13\\n   { //14\\n    $ret0 = t //14\\n    return //14\\n   } //0\\n  } //13\\n } //15\\n { //16\\n  $ret0 = -t //16\\n  return //16\\n } //0\\n\22"
module asm "\09.ascii \22checksum F8350DDAA342F36FCA0C9DA41CF1AAEA468464BE\\n\22"
module asm "\09.text"
...
entry:
  ...
  %mul.0 = shl nuw nsw i32 %zext.0, 3
  %icmp.2 = icmp ult i8 %iand.0, 16
  br i1 %icmp.2, label %then.0, label %else.0

then.0:                                           ; preds = %entry
  %add.0 = add nuw nsw i32 %mul.0, 8
  br label %fallthrough.0

fallthrough.0:                                    ; preds = %else.0, %then.0
  %t.0 = phi i32 [ %add.0, %then.0 ], [ %shl.0, %else.0 ]
  %icmp.3.not = icmp sgt i8 %aVal, -1
  %sub.0 = sub nsw i32 0, %t.0
  %common.ret.op = select i1 %icmp.3.not, i32 %sub.0, i32 %t.0
  ret i32 %common.ret.op

else.0:                                           ; preds = %entry
  %0 = lshr i32 %zext.0, 4
  %iand.2 = and i32 %mul.0, 120
  %add.1 = add nuw nsw i32 %iand.2, 264
  %shl.0 = shl nuw nsw i32 %add.1, %0
  br label %fallthrough.0
}
