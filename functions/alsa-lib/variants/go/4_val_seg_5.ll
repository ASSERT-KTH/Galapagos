...
module asm "\09.ascii \22checksum 9B3A98C85710A22501A2E5AAF16B1158F5F1EC3C\\n\22"
module asm "\09.text"
...
then.6:                                           ; preds = %else.5
  ...
  %icmp.6.not = icmp eq i64 %tmpv.10.sroa.0.0.copyload, %tmpv.11.sroa.0.0.copyload
...
then.19:                                          ; preds = %label.0, %entry.split
  %tmpv.24.018 = phi i64 [ %add.3, %label.0 ], [ 0, %entry.split ]
  ...
  %icmp.17 = icmp eq i32 %tmpv.26.sroa.0.0.copyload, %tmpv.27.sroa.0.0.copyload
...
label.0.1:                                        ; preds = %label.0
  %add.4.1 = add nuw nsw i64 %tmpv.51.011, 2
...
label.0.2:                                        ; preds = %label.0.1
  %add.4.2 = add nuw nsw i64 %tmpv.51.011, 3
...
then.34:                                          ; preds = %label.0.2, %entry.split
  %tmpv.51.011 = phi i64 [ %add.4.2, %label.0.2 ], [ 0, %entry.split ]
...
then.39:                                          ; preds = %then.42
  %icmp.45 = icmp eq ptr %tmpv.67.sroa.0.0.copyload, %tmpv.69.sroa.0.0.copyload
...
then.42:                                          ; preds = %else.41, %entry.split
  ...
  %icmp.44 = icmp eq i64 %tmpv.67.sroa.3.0.copyload, %tmpv.69.sroa.3.0.copyload
