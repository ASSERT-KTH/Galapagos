...
module asm "\09.ascii \22checksum D83C875375349059BF80DE1D4C118C2A67971C13\\n\22"
module asm "\09.text"
...
then.9:                                           ; preds = %else.8
  ...
  %icmp.9.not = icmp eq i64 %tmpv.10.sroa.0.0.copyload, %tmpv.11.sroa.0.0.copyload
...
then.22:                                          ; preds = %label.0, %entry.split
  ...
  %icmp.20 = icmp eq i32 %tmpv.26.sroa.0.0.copyload, %tmpv.27.sroa.0.0.copyload
  %icmp.21 = icmp eq i64 %tmpv.26.sroa.3.0.copyload, %tmpv.27.sroa.3.0.copyload
  %tmpv.33.0.in = select i1 %icmp.20, i1 %icmp.21, i1 false
  %icmp.22 = icmp eq i64 %tmpv.26.sroa.4.0.copyload, %tmpv.27.sroa.4.0.copyload
  %tmpv.34.0.in = select i1 %tmpv.33.0.in, i1 %icmp.22, i1 false
...
then.42:                                          ; preds = %then.45
  %icmp.48 = icmp eq ptr %tmpv.67.sroa.0.0.copyload, %tmpv.69.sroa.0.0.copyload
...
then.45:                                          ; preds = %else.44, %entry.split
  %tmpv.65.019 = phi i64 [ %add.4, %else.44 ], [ 0, %entry.split ]
  ...
  %icmp.47 = icmp eq i64 %tmpv.67.sroa.3.0.copyload, %tmpv.69.sroa.3.0.copyload
