; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/1_mix_2.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/ffmpeg/variants/go/1_mix_2.go:3\\n var blue <type -3> = (((c0 & 31 ) * 2 ) + (c1 & 31 )) //4\\n var green <type -3> = (((2  * (c0 & 992 )) + (c1 & 992 )) >> $convert(<type -12>, 5 )) //5\\n var red <type -3> = (((c0 >> $convert(<type -12>, 10 )) * 2 ) + (c1 >> $convert(<type -12>, 10 ))) //6\\n { //7\\n  $ret0 = ((((red / $convert(<type -3>, 3 )) * $convert(<type -3>, 1024 )) + ((green / $convert(<type -3>, 3 )) * $convert(<type -3>, 32 ))) + (blue / $convert(<type -3>, 3 ))) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum FF4C25A99C9F3E03D77C31D4695BC60D6FF543AF\\n\22"
module asm "\09.text"
