; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/4_int_sin_6.bc'
...
module asm "\09.ascii \22intSinAlt6\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22<type -4>\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 9A7D15DCB5960ABFAA744B25C6D727C6E5D59033\\n\22"
module asm "\09.text"
...
; Function Attrs: null_pointer_is_valid
define i64 @main.intSinAlt6(i8* nest nocapture readnone %nest.0, i64 %a) local_unnamed_addr #0 {
else.8.4:
...
entry:
  %call.0 = call i64 @main.intSinAlt6(i8* nest undef, i64 0)
  ret void
}
