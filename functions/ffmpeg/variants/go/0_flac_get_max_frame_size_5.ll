; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/0_flac_get_max_frame_size_5.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/ffmpeg/variants/go/0_flac_get_max_frame_size_5.go:3\\n var count <type -3> = 16  //4\\n var channels <type -3> = (ch * (((7  + bps) + 7 ) / 8 )) //5\\n var frameSize <type -3> = 0  //6\\n { //7\\n  if (ch == $convert(<type -3>, 2 )) { //7\\n   frameSize = ((((($convert(<type -3>, 2 ) * bps) + $convert(<type -3>, 1 )) * blocksize) + $convert(<type -3>, 7 )) / $convert(<type -3>, 8 )) //8\\n  } else { //9\\n   frameSize = ((((ch * bps) * blocksize) + $convert(<type -3>, 7 )) / $convert(<type -3>, 8 )) //10\\n  } //7\\n } //11\\n count = (count + ((channels + frameSize) + $convert(<type -3>, 2 ))) //12\\n { //13\\n  $ret0 = count //13\\n  return //13\\n } //0\\n\22"
module asm "\09.ascii \22checksum 9C44461DA631125D776B36F70184E61B2123637C\\n\22"
module asm "\09.text"
...
entry:
  ...
  %add.7 = add i32 %add.5, %frameSize.0
  ret i32 %add.7
}
