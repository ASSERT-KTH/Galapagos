; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/3_weight_9.bc'
...
then.1:                                           ; preds = %then.0
  %icmp.0 = icmp eq i32 %i, 0
  %. = select i1 %icmp.0, i32 3, i32 5
  br label %common.ret
...
then.6:                                           ; preds = %then.5
  %icmp.4 = icmp eq i32 %sub.10, %i
  %.34 = select i1 %icmp.4, i32 3, i32 5
  br label %common.ret
