; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/3_weight_6.bc'
...
then.6:                                           ; preds = %then.5
  ...
  %icmp.6 = icmp eq i32 %mul.5, 0
  br i1 %icmp.6, label %then.8, label %else.9
