; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/2_vp5_adjust_0.bc'
...
module asm "\09.ascii \22<type -3>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:487>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/ffmpeg/variants/go/2_vp5_adjust_0.go:3\\n var s1 <type -3> = (v >> $convert(<type -12>, 31 )) //4\\n v = ((v ^ s1) - s1) //5\\n { //6\\n  if (v < ($convert(<type -3>, 2 ) * t)) { //6\\n   v = (v * $convert(<type -3>, 1 )) //7\\n  } else { //8\\n   v = $convert(<type -3>, 0 ) //9\\n  } //6\\n } //10\\n v = (v - t) //11\\n var s2 <type -3> = (v >> $convert(<type -12>, 31 )) //12\\n v = ((v ^ s2) - s2) //13\\n { //14\\n  $ret0 = (((t - v) + s1) ^ s1) //14\\n  return //14\\n } //0\\n\22"
module asm "\09.ascii \22checksum 8677155A42BF35F0ABFD6814DA48B90729875784\\n\22"
module asm "\09.text"
...
entry:
  ...
  %mul.1 = shl i32 %t, 1
  %icmp.0 = icmp slt i32 %sub.0, %mul.1
  %sub.0. = select i1 %icmp.0, i32 %sub.0, i32 0
  %sub.1 = sub i32 %sub.0., %t
