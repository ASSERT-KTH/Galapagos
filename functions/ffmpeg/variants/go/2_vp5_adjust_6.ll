; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/2_vp5_adjust_6.bc'
...
module asm "\09.ascii \22<type -3>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:441>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/ffmpeg/variants/go/2_vp5_adjust_6.go:3\\n var neg <type -3> = (v >> $convert(<type -12>, 31 )) //4\\n v = ((v ^ neg) - neg) //5\\n { //6\\n  if (v >= ($convert(<type -3>, 2 ) * t)) { //6\\n   v = $convert(<type -3>, 0 ) //7\\n  } //6\\n } //8\\n v = (v - t) //9\\n var neg2 <type -3> = (v >> $convert(<type -12>, 31 )) //10\\n v = ((v ^ neg2) - neg2) //11\\n { //12\\n  $ret0 = (((t - v) + neg) ^ neg) //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum 5DAB152EF55256A26AFC0833140498899BB5F29A\\n\22"
module asm "\09.text"
