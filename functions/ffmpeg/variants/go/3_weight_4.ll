; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/3_weight_4.bc'
...
then.6:                                           ; preds = %then.5
  %icmp.5.not = icmp eq i32 %sub.10, %i
  %.34 = select i1 %icmp.5.not, i32 3, i32 5
  br label %common.ret

else.6:                                           ; preds = %then.5
  %sub.6 = sub i32 %sub.10, %i
  %mul.3 = mul i32 %sub.6, 6
