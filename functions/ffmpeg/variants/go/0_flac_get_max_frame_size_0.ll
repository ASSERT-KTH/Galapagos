; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/0_flac_get_max_frame_size_0.bc'
...
module asm "\09.ascii \22<type -3>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:678>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/ffmpeg/variants/go/0_flac_get_max_frame_size_0.go:3\\n var count <type -3> = 16  //4\\n count = (count + (ch * ((($convert(<type -3>, 7 ) + bps) + $convert(<type -3>, 7 )) / $convert(<type -3>, 8 )))) //5\\n { //6\\n  if (ch == $convert(<type -3>, 2 )) { //6\\n   count = (count + ((((($convert(<type -3>, 2 ) * bps) + $convert(<type -3>, 1 )) * blocksize) + $convert(<type -3>, 7 )) / $convert(<type -3>, 8 ))) //7\\n  } else { //8\\n   count = (count + ((((ch * bps) * blocksize) + $convert(<type -3>, 7 )) / $convert(<type -3>, 8 ))) //9\\n  } //6\\n } //10\\n count = (count + $convert(<type -3>, 2 )) //11\\n { //12\\n  $ret0 = count //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum 6D10465F381048167541CBAFD47E259988A68532\\n\22"
module asm "\09.text"
