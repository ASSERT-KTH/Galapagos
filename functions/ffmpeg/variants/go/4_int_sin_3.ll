; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/go/4_int_sin_3.bc'
...
module asm "\09.ascii \22intSinAlt3\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22<type -4>\22"
module asm "\09.ascii \22\\n\22"
module asm "\09.ascii \22checksum 5A09412B3674E095DD2A635CC1C1B64F201373B8\\n\22"
module asm "\09.text"
...
; Function Attrs: null_pointer_is_valid
define i64 @main.intSinAlt3(i8* nest nocapture readnone %nest.0, i64 %a) local_unnamed_addr #0 {
else.8.4:
...
entry:
  %call.0 = call i64 @main.intSinAlt3(i8* nest undef, i64 0)
  ret void
}
