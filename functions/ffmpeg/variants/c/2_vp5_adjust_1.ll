; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/c/2_vp5_adjust_1.bc'
source_filename = "/home/javier/Galapagos/functions/ffmpeg/variants/c/2_vp5_adjust_1.c"
...
entry:
  ...
  %sub5 = sub nsw i32 %xor4, %13
  %sub6 = sub nsw i32 %10, %sub5
  store i32 %sub6, ptr %v.addr, align 4
  %14 = load i32, ptr %v.addr, align 4
  %15 = load i32, ptr %s1, align 4
  %xor7 = xor i32 %14, %15
  %16 = load i32, ptr %s1, align 4
  %add = add nsw i32 %xor7, %16
  ret i32 %add
}
