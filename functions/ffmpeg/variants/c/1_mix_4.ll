; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/c/1_mix_4.bc'
source_filename = "/home/javier/Galapagos/functions/ffmpeg/variants/c/1_mix_4.c"
...
entry:
  ...
  %and4 = and i32 %3, 992
  %4 = load i32, ptr %c1.addr, align 4
  %and5 = and i32 %4, 992
  %add6 = add nsw i32 1, %and5
  %shl = shl i32 %and4, %add6
  %shr = ashr i32 %shl, 5
  ...
  %shr8 = ashr i32 %6, 10
  %add9 = add nsw i32 1, %shr8
  %shl10 = shl i32 %shr7, %add9
  store i32 %shl10, ptr %red, align 4
  %7 = load i32, ptr %red, align 4
  %div = sdiv i32 %7, 3
  %mul = mul nsw i32 %div, 1024
  %8 = load i32, ptr %green, align 4
  %div11 = sdiv i32 %8, 3
  %mul12 = mul nsw i32 %div11, 32
  %add13 = add nsw i32 %mul, %mul12
  %9 = load i32, ptr %blue, align 4
  %div14 = sdiv i32 %9, 3
