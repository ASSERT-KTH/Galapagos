; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/c/0_flac_get_max_frame_size_7.bc'
source_filename = "/home/javier/Galapagos/functions/ffmpeg/variants/c/0_flac_get_max_frame_size_7.c"
...
entry:
  ...
  %audio_frame = alloca i32, align 4
  ...
  store i32 %mul, ptr %audio_frame, align 4
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %div6, %cond.true ], [ %div10, %cond.false ]
  store i32 %cond, ptr %payload, align 4
  %8 = load i32, ptr %base, align 4
  %9 = load i32, ptr %audio_frame, align 4
