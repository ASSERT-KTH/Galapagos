; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/c/2_vp5_adjust_4.bc'
source_filename = "/home/javier/Galapagos/functions/ffmpeg/variants/c/2_vp5_adjust_4.c"
...
entry:
  ...
  store i32 %sub, ptr %abs_v, align 4
  %4 = load i32, ptr %abs_v, align 4
...
if.then:                                          ; preds = %entry
  store i32 0, ptr %abs_v, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %6 = load i32, ptr %t.addr, align 4
  %7 = load i32, ptr %abs_v, align 4
  %sub1 = sub nsw i32 %7, %6
  store i32 %sub1, ptr %abs_v, align 4
  %8 = load i32, ptr %abs_v, align 4
  %shr2 = ashr i32 %8, 31
  store i32 %shr2, ptr %s2, align 4
  %9 = load i32, ptr %abs_v, align 4
  %10 = load i32, ptr %s2, align 4
  %xor3 = xor i32 %9, %10
  %11 = load i32, ptr %s2, align 4
  %sub4 = sub nsw i32 %xor3, %11
  store i32 %sub4, ptr %abs_v, align 4
  %12 = load i32, ptr %t.addr, align 4
  %13 = load i32, ptr %abs_v, align 4
  %sub5 = sub nsw i32 %12, %13
  %14 = load i32, ptr %s1, align 4
  %xor6 = xor i32 %sub5, %14
