...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_2(i64 noundef %a) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_3(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %shr18 = ashr i64 %add17, 4
  ret i64 %shr18
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_4(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
for.end:                                          ; preds = %for.cond
  %17 = load i64, ptr %res, align 8
  %add16 = add nsw i64 %17, 8
  %shr17 = ashr i64 %add16, 4
  ret i64 %shr17
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_5(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %shr15 = ashr i64 %16, 1048576
  store i64 %shr15, ptr %a2, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %18 = load i64, ptr %res, align 8
  %add17 = add nsw i64 %18, 8
  %shr18 = ashr i64 %add17, 4
  ret i64 %shr18
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_6(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %div14 = sdiv i64 %div, %conv13
  store i64 %div14, ptr %a.addr, align 8
  br label %for.inc
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_7(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_8(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_9(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_10(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_11(i64 noundef %a) #0 {
entry:
  %a.addr = alloca i64, align 8
  %a2 = alloca i64, align 8
  %res = alloca i64, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %mul10 = mul nsw i64 %12, %13
  %14 = load i32, ptr %i, align 4
  %mul11 = mul nsw i32 1048576, %14
  %15 = load i32, ptr %i, align 4
  %add12 = add nsw i32 %15, 1
  %mul13 = mul nsw i32 %mul11, %add12
  %conv = sext i32 %mul13 to i64
  %div = sdiv i64 %mul10, %conv
  %sub14 = sub nsw i64 0, %div
  store i64 %sub14, ptr %a.addr, align 8
  br label %for.inc
