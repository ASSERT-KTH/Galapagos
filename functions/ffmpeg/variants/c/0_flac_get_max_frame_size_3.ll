; ModuleID = '/home/javier/Galapagos/functions/ffmpeg/variants/c/0_flac_get_max_frame_size_3.bc'
source_filename = "/home/javier/Galapagos/functions/ffmpeg/variants/c/0_flac_get_max_frame_size_3.c"
...
if.then:                                          ; preds = %entry
  ...
  %mul4 = mul nsw i32 %add3, %5
  %add5 = add nsw i32 %mul4, 7
  %div6 = sdiv i32 %add5, 8
  store i32 %div6, ptr %size, align 4
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  store i32 %div10, ptr %size, align 4
  br label %if.end
