/* Function variant avoiding usage of goto and streamlining the size of checking 

enum {
    MBA_UNIBYTE_ONLY = 1
} mbsAlignFlags;
mbsalign (char const *src, char *dest, size_t dest_size,
          size_t *width, mbs_align_t align, mbsAlignFlags flags)
{
  size_t ret = SIZE_MAX;
  ...
  if ((newstr != nullptr) || (flags & MBA_UNIBYTE_ONLY))
    {
