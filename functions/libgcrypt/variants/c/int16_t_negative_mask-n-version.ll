; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/2_int16_t_negative_mask.bc'
source_filename = "/home/javier/Galapagos/functions/libgcrypt/2_int16_t_negative_mask.run.c"
...
true5:                                            ; preds = %true4
  %15 = icmp eq i32 %1, %8
  br i1 %15, label %true6, label %error

true6:                                            ; preds = %true5
  ret i32 %1

error:                                            ; preds = %true5, %true4, %true3, %true2, %true1, %true, %comparisons
  call void @llvm.trap()
  unreachable
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_2(i16 noundef signext %x) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_3(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_4(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_5(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_6(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_7(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @version_8(i16 noundef signext %x) #0 {
entry:
  %x.addr = alloca i16, align 2
  store i16 %x, ptr %x.addr, align 2
  %0 = load i16, ptr %x.addr, align 2
