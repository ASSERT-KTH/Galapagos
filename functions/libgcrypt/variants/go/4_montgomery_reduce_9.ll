; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_9.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:346>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_9.go:3\\n var t <type -2> = $convert(<type -2>, (a * $convert(<type -3>, -3327 ))) //4\\n var res <type -3> = ((a - ($convert(<type -3>, t) * $convert(<type -3>, 3329 ))) >> $convert(<type -12>, 16 )) //5\\n { //6\\n  $ret0 = $convert(<type -2>, res) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 73E67D026B80782BF2489709942EADC869713316\\n\22"
module asm "\09.text"
