; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_2.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_2.go:3\\n var t <type -2> = $convert(<type -2>, (((($convert(<type -3>, 20159 ) * $convert(<type -3>, a)) + $convert(<type -3>, 33554432 )) >> $convert(<type -12>, 26 )) * $convert(<type -3>, 3329 ))) //5\\n { //6\\n  $ret0 = (a - t) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum BB2F86740A02047A43B07E4A835A4CDCB8EBE397\\n\22"
module asm "\09.text"
