; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_8.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_8.go:3\\n var t <type -3> = ((($convert(<type -3>, a) * 20159 ) + 33554432 ) >> $convert(<type -12>, 26 )) //5\\n { //6\\n  $ret0 = $convert(<type -2>, ($convert(<type -3>, a) - (t * $convert(<type -3>, 3329 )))) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 2906350A1556AE6A25DE78EE2E8261FF6F7841AC\\n\22"
module asm "\09.text"
