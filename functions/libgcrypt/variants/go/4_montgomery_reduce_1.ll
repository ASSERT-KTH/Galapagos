; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_1.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_1.go:3\\n var t <type -2> = ($convert(<type -2>, a) * -3327 ) //4\\n { //5\\n  $ret0 = $convert(<type -2>, ((a - ($convert(<type -3>, t) * $convert(<type -3>, 3329 ))) >> $convert(<type -12>, 16 ))) //5\\n  return //5\\n } //0\\n\22"
module asm "\09.ascii \22checksum 33C459316ACC932513D367E9929D3E13691DA681\\n\22"
module asm "\09.text"
