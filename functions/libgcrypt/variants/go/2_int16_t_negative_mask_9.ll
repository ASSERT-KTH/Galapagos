; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/2_int16_t_negative_mask_9.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:207>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/2_int16_t_negative_mask_9.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, -($convert(<type -6>, x) >> $convert(<type -12>, 15 ))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 3A101DADF8E6D538E5D749F0AB0B596ABE8C91B9\\n\22"
module asm "\09.text"
...
entry:
  ...
  %zext.0 = zext i16 %shr.0.neg to i32
  ret i32 %zext.0
}
