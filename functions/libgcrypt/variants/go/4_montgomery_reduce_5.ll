; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_5.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:325>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_5.go:3\\n var t <type -2> = $convert(<type -2>, (a * $convert(<type -3>, -3327 ))) //4\\n var t32 <type -3> = ($convert(<type -3>, t) * 3329 ) //5\\n { //6\\n  $ret0 = $convert(<type -2>, ((a - t32) >> $convert(<type -12>, 16 ))) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum 184DB33EB135C6675D7F5D97332BA3E043CBC3AE\\n\22"
module asm "\09.text"
