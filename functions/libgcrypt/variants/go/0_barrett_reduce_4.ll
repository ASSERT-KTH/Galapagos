; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_4.bc'
...
module asm "\09.ascii \22<type -2>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:356>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_4.go:3\\n var tmp <type -3> = ($convert(<type -3>, a) * 20159 ) //5\\n tmp = (tmp + $convert(<type -3>, 33554432 )) //6\\n tmp = (tmp >> $convert(<type -12>, 26 )) //7\\n tmp = (tmp * $convert(<type -3>, 3329 )) //8\\n { //9\\n  $ret0 = (a - $convert(<type -2>, tmp)) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 438CD29224203DAC37C13C87CD9EA6D1F5EFC267\\n\22"
module asm "\09.text"
