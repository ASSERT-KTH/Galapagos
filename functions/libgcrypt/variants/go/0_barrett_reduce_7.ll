; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_7.bc'
...
module asm "\09.ascii \22<type -2>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:347>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_7.go:3\\n var temp <type -3> = ((20159  * $convert(<type -3>, a)) + 33554432 ) //5\\n temp = (temp >> $convert(<type -12>, 26 )) //6\\n temp = (temp * $convert(<type -3>, 3329 )) //7\\n { //8\\n  $ret0 = $convert(<type -2>, ($convert(<type -3>, a) - temp)) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum 2617D6B33F35D7701EE1B2F8D7A08439E5846F7A\\n\22"
module asm "\09.text"
