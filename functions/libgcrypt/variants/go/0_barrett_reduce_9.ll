; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_9.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_9.go:3\\n var t <type -3> = (((20159  * $convert(<type -3>, a)) + 33554432 ) >> $convert(<type -12>, 26 )) //5\\n t = (t * $convert(<type -3>, 3329 )) //6\\n { //7\\n  $ret0 = $convert(<type -2>, ($convert(<type -3>, a) - t)) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 596D7721DF350DC6230B57399D9FF8EE801BE8BD\\n\22"
module asm "\09.text"
