; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_3.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_3.go:3\\n var t <type -2> = $convert(<type -2>, (a * $convert(<type -3>, -3327 ))) //4\\n { //5\\n  $ret0 = $convert(<type -2>, ((a - ($convert(<type -3>, t) * $convert(<type -3>, 3329 ))) >> $convert(<type -12>, 16 ))) //5\\n  return //5\\n } //0\\n\22"
module asm "\09.ascii \22checksum A39BE591E05FC630C6958FF6BA46F70080238A63\\n\22"
module asm "\09.text"
