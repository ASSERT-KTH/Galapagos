; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/2_int16_t_negative_mask_6.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:229>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/2_int16_t_negative_mask_6.go:3\\n { //4\\n  $ret0 = -$convert(<type -11>, $convert(<type -7>, ($convert(<type -6>, x) >> $convert(<type -12>, 15 )))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum CF5E666170ED3F156E84EDACE324E42888076E75\\n\22"
module asm "\09.text"
...
entry:
  %shr.0 = lshr i16 %x, 15
  %zext.1 = zext i16 %shr.0 to i64
  %sub.0 = sub nsw i64 0, %zext.1
  ret i64 %sub.0
}
