; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_3.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_3.go:3\\n var t <type -3> = (((20159  * $convert(<type -3>, a)) + 33554432 ) >> $convert(<type -12>, 26 )) //5\\n var t512 <type -3> = (t * 3329 ) //6\\n { //7\\n  $ret0 = (a - $convert(<type -2>, t512)) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum BC164D0F16FA0878E227EB1D7AEFB944262244FC\\n\22"
module asm "\09.text"
