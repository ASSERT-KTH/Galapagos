; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/3_int16_t_nonzero_mask_7.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/3_int16_t_nonzero_mask_7.go:3\\n var v <type -7> = -$convert(<type -7>, $convert(<type -6>, x)) //4\\n { //5\\n  $ret0 = $convert(<type -3>, ((v >> $convert(<type -12>, 31 )) & $convert(<type -7>, 1 ))) //5\\n  return //5\\n } //0\\n\22"
module asm "\09.ascii \22checksum B25383A5CA27F3C10BE9321D2459956F2C0430A4\\n\22"
module asm "\09.text"
