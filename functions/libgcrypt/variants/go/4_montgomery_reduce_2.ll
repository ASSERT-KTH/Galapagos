; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_2.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:304>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/4_montgomery_reduce_2.go:3\\n var t <type -2> = ($convert(<type -2>, a) * -3327 ) //4\\n var t32 <type -3> = ($convert(<type -3>, t) * 3329 ) //5\\n { //6\\n  $ret0 = $convert(<type -2>, ((a - t32) >> $convert(<type -12>, 16 ))) //6\\n  return //6\\n } //0\\n\22"
module asm "\09.ascii \22checksum CD2D0DB62C925CA86D7D2B36B8569A292A76E469\\n\22"
module asm "\09.text"
