; ModuleID = '/home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_5.bc'
...
module asm "\09.ascii \22<type -2>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:320>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/libgcrypt/variants/go/0_barrett_reduce_5.go:3\\n var tmp <type -3> = ((20159  * $convert(<type -3>, a)) + 33554432 ) //5\\n tmp = (tmp >> $convert(<type -12>, 26 )) //6\\n tmp = (tmp * $convert(<type -3>, 3329 )) //7\\n { //8\\n  $ret0 = (a - $convert(<type -2>, tmp)) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum 74B9C8B4C9617BE32F030E9A00F37D31571C9785\\n\22"
module asm "\09.text"
