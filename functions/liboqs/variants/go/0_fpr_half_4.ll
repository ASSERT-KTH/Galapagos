; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_4.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_4.go:3\\n { //4\\n  if (((x >> $convert(<type -12>, 52 )) & $convert(<type -8>, 2047 )) == $convert(<type -8>, 0 )) { //4\\n   { //5\\n    $ret0 = (x >> $convert(<type -12>, 1 )) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = (x - $convert(<type -8>, 4503599627370496 )) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 92B05D858FDE80738549E7E03260628EC49E9C44\\n\22"
module asm "\09.text"
