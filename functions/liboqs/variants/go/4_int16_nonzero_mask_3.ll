; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_3.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_3.go:3\\n { //4\\n  if (x == $convert(<type -2>, 0 )) { //4\\n   { //5\\n    $ret0 = $convert(<type -3>, 0 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = $convert(<type -3>, -1 ) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 2F2DD57F91180377049034CE18331CBBB287D34D\\n\22"
module asm "\09.text"
