; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_0.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:436>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_0.go:3\\n var z <type -8> = ($convert(<type -8>, a) * $convert(<type -8>, b)) //4\\n var w <type -8> = (((z * $convert(<type -8>, p0i)) & 2147483647 ) * $convert(<type -8>, p)) //5\\n var d <type -7> = ($convert(<type -7>, ((z + w) >> $convert(<type -12>, 31 ))) - p) //6\\n d = (d + (p & -(d >> $convert(<type -12>, 31 )))) //7\\n { //8\\n  $ret0 = d //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum 1F533121F9A2ED46F95BE14EF0DD805FE52D7D10\\n\22"
module asm "\09.text"
...
entry:
  ...
  %isneg = icmp slt i32 %sub.0, 0
  %add.1 = select i1 %isneg, i32 %trunc.0, i32 %sub.0
  ret i32 %add.1
}
