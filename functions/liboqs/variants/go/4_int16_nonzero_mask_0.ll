; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_0.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_0.go:3\\n var u <type -6> = $convert(<type -6>, x) //4\\n { //5\\n  if (u == $convert(<type -6>, 0 )) { //5\\n   { //6\\n    $ret0 = $convert(<type -3>, 0 ) //6\\n    return //6\\n   } //0\\n  } //5\\n } //7\\n { //8\\n  $ret0 = $convert(<type -3>, -1 ) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum A0B8D2E8E4C024D42646B7B7F09E06C2F61F6823\\n\22"
module asm "\09.text"
