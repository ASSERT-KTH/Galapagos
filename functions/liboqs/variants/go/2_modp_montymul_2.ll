; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_2.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_2.go:3\\n var z <type -8> = ($convert(<type -8>, a) * $convert(<type -8>, b)) //4\\n var w <type -8> = (((z * $convert(<type -8>, p0i)) & 2147483647 ) * $convert(<type -8>, p)) //5\\n var d <type -7> = $convert(<type -7>, ((z + w) >> $convert(<type -12>, 31 ))) //6\\n { //7\\n  if (d < p) { //7\\n   { //8\\n    $ret0 = d //8\\n    return //8\\n   } //0\\n  } //7\\n } //9\\n { //10\\n  $ret0 = (d - p) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 48DC7D579F734AA12C738D992D1C76920F89E021\\n\22"
module asm "\09.text"
