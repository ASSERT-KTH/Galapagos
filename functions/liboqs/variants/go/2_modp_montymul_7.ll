; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_7.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:466>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_7.go:3\\n var z <type -8> = ($convert(<type -8>, a) * $convert(<type -8>, b)) //4\\n var w <type -8> = (((z * $convert(<type -8>, p0i)) & 2147483647 ) * $convert(<type -8>, p)) //5\\n var d <type -7> = ($convert(<type -7>, ((z + w) >> $convert(<type -12>, 31 ))) - p) //6\\n { //7\\n  if (d < $convert(<type -7>, 0 )) { //7\\n   d = (d + p) //8\\n  } //7\\n } //9\\n { //10\\n  $ret0 = d //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 7F3B494A0F71E7D7FE1A32593D809F5920323CF8\\n\22"
module asm "\09.text"
