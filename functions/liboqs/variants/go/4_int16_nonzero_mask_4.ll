; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_4.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_4.go:3\\n var u <type -7> = $convert(<type -7>, x) //4\\n { //5\\n  if (u != $convert(<type -7>, 0 )) { //5\\n   { //6\\n    $ret0 = $convert(<type -3>, -1 ) //6\\n    return //6\\n   } //0\\n  } //5\\n } //7\\n { //8\\n  $ret0 = $convert(<type -3>, 0 ) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum 238F699719736F563D567EEF8C82A22960588251\\n\22"
module asm "\09.text"
