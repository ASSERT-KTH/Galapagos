; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_5.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_5.go:3\\n { //4\\n  if ((x >> $convert(<type -12>, 63 )) == (y >> $convert(<type -12>, 63 ))) { //4\\n   { //5\\n    $ret0 = $convert(<type -3>, ((($convert(<type -4>, x) - $convert(<type -4>, y)) >> $convert(<type -12>, 63 )) & $convert(<type -4>, 1 ))) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  if ((x >> $convert(<type -12>, 63 )) == $convert(<type -8>, 1 )) { //7\\n   { //8\\n    $ret0 = $convert(<type -3>, 1 ) //8\\n    return //8\\n   } //0\\n  } //7\\n } //9\\n { //10\\n  $ret0 = $convert(<type -3>, 0 ) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 3BCD833482DBDDDB03B2D02E59731A3AB8DF9376\\n\22"
module asm "\09.text"
...
entry:
  %shr.1 = lshr i64 %x, 63
  %shr.2 = lshr i64 %y, 63
  %icmp.0 = icmp eq i64 %shr.1, %shr.2
  %sub.0 = sub i64 %x, %y
  %shr.09 = lshr i64 %sub.0, 63
  %common.ret.op.v = select i1 %icmp.0, i64 %shr.09, i64 %shr.1
