; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_2.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:601>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_2.go:3\\n var sx <type -4> = $convert(<type -4>, x) //4\\n var sy <type -4> = $convert(<type -4>, y) //5\\n { //6\\n  if ((sx ^ sy) < $convert(<type -4>, 0 )) { //6\\n   { //7\\n    if (sx < $convert(<type -4>, 0 )) { //7\\n     { //8\\n      $ret0 = $convert(<type -3>, 1 ) //8\\n      return //8\\n     } //0\\n    } //7\\n   } //9\\n   { //10\\n    $ret0 = $convert(<type -3>, 0 ) //10\\n    return //10\\n   } //0\\n  } //6\\n } //11\\n { //12\\n  $ret0 = ($convert(<type -3>, ((sx - sy) >> $convert(<type -12>, 63 ))) & $convert(<type -3>, 1 )) //12\\n  return //12\\n } //0\\n\22"
module asm "\09.ascii \22checksum DD3D03D19418CD79354F820AC1C59318D2A11C50\\n\22"
module asm "\09.text"
...
entry:
  %xor.0 = xor i64 %y, %x
  %icmp.1 = icmp slt i64 %xor.0, 0
  %sub.0 = select i1 %icmp.1, i64 0, i64 %y
