; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_1.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:527>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_1.go:3\\n var sy <type -4> = y //4\\n { //5\\n  if (((x ^ y) >> $convert(<type -12>, 63 )) != $convert(<type -4>, 0 )) { //5\\n   sy = x //6\\n  } //5\\n } //7\\n var cc0 <type -3> = ($convert(<type -3>, ((x - sy) >> $convert(<type -12>, 63 ))) & 1 ) //8\\n var cc1 <type -3> = ($convert(<type -3>, ((sy - x) >> $convert(<type -12>, 63 ))) & 1 ) //9\\n { //10\\n  $ret0 = (cc0 ^ ((cc0 ^ cc1) & $convert(<type -3>, ((x & y) >> $convert(<type -12>, 63 ))))) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 3C1F0A37AB611F0BD424C23241EFD2FB0490F43B\\n\22"
module asm "\09.text"
...
entry:
  ...
  %trunc.1 = trunc i64 %shr.113 to i32
  %sub.1 = sub i64 %spec.select, %x
  %shr.214 = lshr i64 %sub.1, 63
  %iand.2 = and i64 %y, %x
  %xor.115 = xor i64 %shr.113, %shr.214
