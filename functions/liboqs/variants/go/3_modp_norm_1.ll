; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_1.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:289>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_1.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, (x - (p & $convert(<type -7>, -($convert(<type -3>, (x - ((p + $convert(<type -7>, 1 )) >> $convert(<type -12>, 1 )))) >> $convert(<type -12>, 31 )))))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 8FC2E7330571662C6D2913F64B25E34BF6FB1B33\\n\22"
module asm "\09.text"
...
entry:
  ...
  %shr.1.neg = lshr i32 %sub.0, 31
  %iand.0 = and i32 %shr.1.neg, %p
