; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_7.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:273>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_7.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, ((x - ((p & ^(x - ((p + $convert(<type -7>, 1 )) / $convert(<type -7>, 2 )))) >> $convert(<type -12>, 31 ))) + $convert(<type -7>, 1 ))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 350B169496CA13CD3CA46A5D5F4FB2D59A120326\\n\22"
module asm "\09.text"
...
entry:
  %add.0 = add i32 %p, 1
  %div.0 = lshr i32 %add.0, 1
  %0 = xor i32 %x, -1
  %xor.0 = add i32 %div.0, %0
  %iand.0 = and i32 %xor.0, %p
  %shr.0.neg = ashr i32 %iand.0, 31
  %sub.1 = add i32 %x, 1
  %add.1 = add i32 %sub.1, %shr.0.neg
  ret i32 %add.1
}
