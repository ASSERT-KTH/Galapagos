; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_1.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:367>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_1.go:3\\n var expMask <type -8> = 9218868437227405312  //4\\n { //5\\n  if ((x & expMask) == $convert(<type -8>, 0 )) { //5\\n   { //6\\n    $ret0 = (x >> $convert(<type -12>, 1 )) //6\\n    return //6\\n   } //0\\n  } //5\\n } //7\\n { //8\\n  $ret0 = (x - $convert(<type -8>, 2251799813685248 )) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum CDA60BABAF83D6CE8CF30D6715D4BBBB79229D99\\n\22"
module asm "\09.text"
...
entry:
  ...
  %shr.0 = lshr i64 %x, 1
  %sub.0 = add i64 %x, -2251799813685248
  %common.ret.op = select i1 %icmp.0, i64 %shr.0, i64 %sub.0
