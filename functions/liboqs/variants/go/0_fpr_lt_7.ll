; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_7.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:492>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_7.go:3\\n var sameSign <type -4> = ((x ^ y) >> $convert(<type -12>, 63 )) //4\\n var sy <type -4> = (y & ^sameSign) //5\\n var cc0 <type -3> = ($convert(<type -3>, ((x - sy) >> $convert(<type -12>, 63 ))) & 1 ) //6\\n var cc1 <type -3> = ($convert(<type -3>, ((sy - x) >> $convert(<type -12>, 63 ))) & 1 ) //7\\n { //8\\n  $ret0 = (cc0 ^ ((cc0 ^ cc1) & $convert(<type -3>, ((x & y) >> $convert(<type -12>, 63 ))))) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum A7E9F4623E47C4BF0312CE52A3D82301D7A4EC9B\\n\22"
module asm "\09.text"
...
entry:
  ...
  %trunc.0 = trunc i64 %shr.113 to i32
  %sub.1 = sub i64 %iand.0, %x
  %shr.214 = lshr i64 %sub.1, 63
  %iand.3 = and i64 %y, %x
  %xor.215 = xor i64 %shr.113, %shr.214
  %isneg17 = icmp slt i64 %iand.3, 0
  %0 = trunc i64 %xor.215 to i32
  %iand.4 = select i1 %isneg17, i32 %0, i32 0
