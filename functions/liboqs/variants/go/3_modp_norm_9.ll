; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_9.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:311>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_9.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, (x - (p & ($convert(<type -7>, 2147483647 ) & (((x - ((p + $convert(<type -7>, 1 )) >> $convert(<type -12>, 1 ))) >> $convert(<type -12>, 31 )) - $convert(<type -7>, 1 )))))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 2A543F6885E87EDC9EA4D9D3AF1412EC554FAB3D\\n\22"
module asm "\09.text"
...
entry:
  ...
  %sub.1 = add nuw i32 %shr.1, 2147483647
  %iand.0 = and i32 %p, 2147483647
  %iand.1 = and i32 %iand.0, %sub.1
  %sub.2 = sub i32 %x, %iand.1
  ret i32 %sub.2
}
