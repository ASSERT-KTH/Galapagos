; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_5.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:476>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/2_modp_montymul_5.go:3\\n var z <type -8> = ($convert(<type -8>, a) * $convert(<type -8>, b)) //4\\n var w <type -8> = (((z * $convert(<type -8>, p0i)) & 2147483647 ) * $convert(<type -8>, p)) //5\\n var d <type -7> = $convert(<type -7>, ((z + w) >> $convert(<type -12>, 31 ))) //6\\n { //7\\n  if (d < p) { //7\\n   { //8\\n    $ret0 = d //8\\n    return //8\\n   } //0\\n  } //7\\n } //9\\n { //10\\n  $ret0 = (d - p) //10\\n  return //10\\n } //0\\n\22"
module asm "\09.ascii \22checksum 94AAA5066886DC0737454217F6DC232E105FFC23\\n\22"
module asm "\09.text"
...
entry:
  ...
  %icmp.0 = icmp ult i32 %trunc.0, %p
  %sub.0 = select i1 %icmp.0, i32 0, i32 %p
  %common.ret.op = sub i32 %trunc.0, %sub.0
