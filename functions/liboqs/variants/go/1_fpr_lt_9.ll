; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_9.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:635>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_9.go:3\\n { //4\\n  if ((x < $convert(<type -8>, 9223372036854775808 )) == (y < $convert(<type -8>, 9223372036854775808 ))) { //4\\n   { //5\\n    $ret0 = $convert(<type -3>, ((($convert(<type -4>, x) - $convert(<type -4>, y)) >> $convert(<type -12>, 63 )) & $convert(<type -4>, 1 ))) //5\\n    return //5\\n   } //0\\n  } else { //6\\n   { //6\\n    if (x < $convert(<type -8>, 9223372036854775808 )) { //6\\n     { //7\\n      $ret0 = $convert(<type -3>, 0 ) //7\\n      return //7\\n     } //0\\n    } //6\\n   } //8\\n  } //4\\n } //8\\n { //9\\n  $ret0 = $convert(<type -3>, 1 ) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum B14772636A1EEB655688FC6F443AB3E697BAF658\\n\22"
module asm "\09.text"
...
entry:
  ...
  %1 = trunc i64 %y.lobit to i8
  %icmp.3 = icmp eq i8 %0, %1
  %sub.0 = select i1 %icmp.3, i64 %y, i64 0
