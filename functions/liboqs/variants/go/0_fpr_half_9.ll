; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_9.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:494>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_half_9.go:3\\n { //4\\n  if (((x >> $convert(<type -12>, 52 )) & $convert(<type -8>, 2047 )) == $convert(<type -8>, 0 )) { //4\\n   { //5\\n    $ret0 = (x >> $convert(<type -12>, 1 )) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = ((x & $convert(<type -8>, 4503599627370495 )) | ((((x >> $convert(<type -12>, 52 )) - $convert(<type -8>, 1 )) & $convert(<type -8>, 2047 )) << $convert(<type -12>, 52 ))) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 8BEEFC7FE92EDD1C1E55C09EA1B4EEAF3ED6A3B3\\n\22"
module asm "\09.text"
...
then.0:                                           ; preds = %entry
  ...
  %iand.2 = and i64 %x, 4503599627370495
  %1 = add i64 %x, 9218868437227405312
  %shl.0 = and i64 %1, 9218868437227405312
  %ior.0 = or i64 %shl.0, %iand.2
  br label %common.ret
}
