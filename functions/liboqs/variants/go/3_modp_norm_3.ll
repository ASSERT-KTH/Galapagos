; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_3.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:353>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_3.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, (x - (p * $convert(<type -7>, (((((x - ((p + $convert(<type -7>, 1 )) >> $convert(<type -12>, 1 ))) >> $convert(<type -12>, 31 )) * $convert(<type -7>, 2 )) >> $convert(<type -12>, 1 )) - $convert(<type -7>, 1 )))))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum C8980282051C033FE32E943C3E56E8CF33FB23C6\\n\22"
module asm "\09.text"
...
entry:
  ...
  %.neg = ashr i32 %sub.0, 31
  %sub.1.neg = add nsw i32 %.neg, 1
  %mul.1.neg = mul nuw nsw i32 %sub.1.neg, %p
  %sub.2 = add i32 %mul.1.neg, %x
  ret i32 %sub.2
}
