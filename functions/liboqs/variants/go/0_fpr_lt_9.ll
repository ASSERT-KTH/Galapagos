; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_9.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:484>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/0_fpr_lt_9.go:3\\n var flip <type -4> = ^((x ^ y) >> $convert(<type -12>, 63 )) //4\\n var sy <type -4> = (y & flip) //5\\n var cc0 <type -3> = ($convert(<type -3>, ((x - sy) >> $convert(<type -12>, 63 ))) & 1 ) //6\\n var cc1 <type -3> = ($convert(<type -3>, ((sy - x) >> $convert(<type -12>, 63 ))) & 1 ) //7\\n { //8\\n  $ret0 = (cc0 ^ ((cc0 ^ cc1) & $convert(<type -3>, ((x & y) >> $convert(<type -12>, 63 ))))) //8\\n  return //8\\n } //0\\n\22"
module asm "\09.ascii \22checksum 043ABC3F86CE57D73822FD06F8211BDCFCBDD2A9\\n\22"
module asm "\09.text"
