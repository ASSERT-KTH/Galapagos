; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_5.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:339>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_5.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, ($convert(<type -11>, x) - $convert(<type -11>, (p & $convert(<type -7>, (((x - ((p + $convert(<type -7>, 1 )) >> $convert(<type -12>, 1 ))) >> $convert(<type -12>, 31 )) - $convert(<type -7>, 1 ))))))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 120E377AC62C2608075982A35A0BCAADBD580D82\\n\22"
module asm "\09.text"
