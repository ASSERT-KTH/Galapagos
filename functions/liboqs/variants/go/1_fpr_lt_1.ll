; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_1.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:293>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/1_fpr_lt_1.go:3\\n { //4\\n  if ($convert(<type -4>, x) < $convert(<type -4>, y)) { //4\\n   { //5\\n    $ret0 = $convert(<type -3>, 1 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = $convert(<type -3>, 0 ) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum E1050E6C6C02331DCA7B7BB4886CF687EC239D23\\n\22"
module asm "\09.text"
...
entry:
  %icmp.0 = icmp slt i64 %x, %y
  %. = zext i1 %icmp.0 to i32
  ret i32 %.
}
