; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_5.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/4_int16_nonzero_mask_5.go:3\\n { //4\\n  if (x != $convert(<type -2>, 0 )) { //4\\n   { //5\\n    $ret0 = $convert(<type -3>, -1 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //7\\n  $ret0 = $convert(<type -3>, 0 ) //7\\n  return //7\\n } //0\\n\22"
module asm "\09.ascii \22checksum 6E418CC83317685EDB9CBD4C6D0EFA2B68631F12\\n\22"
module asm "\09.text"
