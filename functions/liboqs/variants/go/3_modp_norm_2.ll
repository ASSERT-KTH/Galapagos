; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_2.bc'
...
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:337>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/liboqs/variants/go/3_modp_norm_2.go:3\\n { //4\\n  $ret0 = $convert(<type -3>, (x - $convert(<type -7>, ($convert(<type -3>, p) * $convert(<type -3>, (((x - ((p + $convert(<type -7>, 1 )) >> $convert(<type -12>, 1 ))) >> $convert(<type -12>, 31 )) - $convert(<type -7>, 1 ))))))) //4\\n  return //4\\n } //0\\n\22"
module asm "\09.ascii \22checksum 391348C82104AF706A9BDAD89F1EE7CDEB2DCBA9\\n\22"
module asm "\09.text"
...
entry:
  ...
  %shr.1.neg = ashr i32 %sub.0, 31
  %sub.1.neg = add nsw i32 %shr.1.neg, 1
  %mul.0.neg = mul nuw nsw i32 %sub.1.neg, %p
  %sub.2 = add i32 %mul.0.neg, %x
  ret i32 %sub.2
}
