; ModuleID = '/home/javier/Galapagos/functions/liboqs/variants/c/1_fpr_lt_7.bc'
source_filename = "/home/javier/Galapagos/functions/liboqs/variants/c/1_fpr_lt_7.c"
...
entry:
  ...
  %and1 = and i64 %3, -9223372036854775808
  %cmp = icmp ne i64 %and, %and1
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %4 = load i64, ptr %sx, align 8
  %and2 = and i64 %4, -9223372036854775808
