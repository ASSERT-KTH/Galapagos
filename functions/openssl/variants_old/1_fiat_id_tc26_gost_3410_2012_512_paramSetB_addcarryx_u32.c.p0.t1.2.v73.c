static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    ...
    uint32_t arg3) {
    uint64_t temp;
    temp = (arg1 + (uint64_t)arg2);
    uint64_t x1 = (temp + arg3);
    uint32_t x2 = (uint32_t)(x1 % UINT32_MAX + 1);
    fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1 x3 = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(x1 / (UINT32_MAX + 1));
    *out1 = x2;
    *out2 = x3;
}