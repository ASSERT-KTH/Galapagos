static void fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_addcarryx_u32(
    ...
    //changing the order 
    x1 = ((arg1 + arg3) + (uint64_t)arg2);
    
    x2 = (uint32_t)(x1 & UINT32_C(0xffffffff));
    x3 = (fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1)(x1 >> 32);
    
    // store the values first in temp variables and then in out arguments.
    uint32_t temp_out1 = x2;
    fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1 temp_out2 = x3;
