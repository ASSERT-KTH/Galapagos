static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    ...
    uint64_t x1;
    uint32_t x4;
    fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1 x5;
    x1 = ((arg1 + (uint64_t) arg3) + arg2);
    x4 = (uint32_t)(x1 % UINT32_C(0x100000000));
    x5 = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(x1 / UINT32_C(0x100000000));
    *out1 = x4; 
    *out2 = x5; 
}
