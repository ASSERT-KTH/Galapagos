static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    ...
    x2 = (uint32_t)((x1 & UINT32_C(0xffffffff)) + 0); //Adding 0 does not change this value, adds behavior variability 
    x3 = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(x1 >> 32);
    *out1 = x2;
    *out2 = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(x3+ 0); //Adding 0 does not change this value, adds behavior variability 
}