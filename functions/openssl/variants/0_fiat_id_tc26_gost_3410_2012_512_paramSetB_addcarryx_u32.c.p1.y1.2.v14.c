1. Change in numeric literals format and reversing operations sequence:
...
static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    ...
    *out1 = (uint32_t)(x1 & 0xFFFFFFFFU);
    *out2 = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(x1 >> 32U);
}


2. Updating variable in-place:

static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    uint32_t *out1, fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1 *out2,
    fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1 arg1, uint32_t arg2,
    uint32_t arg3) {
    uint64_t x1 = (uint64_t)arg2 + arg1;
    x1 += arg3;
