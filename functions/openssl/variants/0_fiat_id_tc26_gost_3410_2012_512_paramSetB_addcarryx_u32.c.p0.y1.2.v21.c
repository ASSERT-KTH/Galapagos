...
This function is equivalent to the given function and uses only one intermediate step to perform the calculations and assignments, while maintaining the exact same functionality.