static void fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_addcarryx_u32(
    ...
    x2 = (uint32_t)(((uint64_t)arg1 + arg2) & UINT32_C(0xffffffff));
    x3 = (fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1)(((uint64_t)arg1 + arg2) >> 32);
    *out1 = x2;
    *out2 = x3;
