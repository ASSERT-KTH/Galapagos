static void fiat_id_tc26_gost_3410_2012_512_paramSetB_addcarryx_u32(
    ...
    uint32_t arg3) {
    uint64_t sum;
    uint32_t sum_lower_32bits;
    fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1 sum_upper_bit;

    sum = ((uint64_t)arg1 + arg2) + arg3;
    sum_lower_32bits = (uint32_t)(sum & UINT32_C(0xffffffff));
    sum_upper_bit = (fiat_id_tc26_gost_3410_2012_512_paramSetB_uint1)(sum >> 32);

    *out1 = sum_lower_32bits;
    *out2 = sum_upper_bit;
}