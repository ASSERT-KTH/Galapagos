; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_3.bc'
...
module asm "\09.ascii \22boothRecodeW7_3\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:402>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_3.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 7 )) - 1 ) //4\\n var d <type -7> = ((256  - in) - 1 ) //5\\n d = ((d & s) | (in & ^s)) //6\\n d = ((d >> $convert(<type -12>, 1 )) + (d & $convert(<type -7>, 1 ))) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 8AF1B4422D1E8A2FD3CA8EB0ABDC847A72486E73\\n\22"
module asm "\09.text"
...
define i32 @main.boothRecodeW7__3(i8* nest nocapture readnone %nest.0, i32 %in) local_unnamed_addr #1 {
entry:
  %shr.0 = lshr i32 %in, 7
  %sub.0 = add nsw i32 %shr.0, -1
  %xor.0 = sub nsw i32 0, %shr.0
  %sub.2 = sub i32 255, %in
