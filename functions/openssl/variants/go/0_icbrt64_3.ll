; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/0_icbrt64_3.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:749>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/0_icbrt64_3.go:3\\n var r <type -8> = 0  //4\\n { //6\\n  var s <type -11> = 63  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    r = (r << $convert(<type -12>, 1 )) //7\\n    var temp <type -8> = (r + 1 ) //8\\n    var b <type -8> = (((3  * r) * temp) + 1 ) //9\\n    { //10\\n     if ((x >> $convert(<type -12>, s)) >= b) { //10\\n      x = (x - (b << $convert(<type -12>, s))) //11\\n      r = (r + $convert(<type -8>, 1 )) //12\\n     } //10\\n    } //13\\n   } //14\\n   { //6\\n    s = (s - $convert(<type -11>, 3 )) //6\\n   } //6\\n   :$l0 //6\\n   if (s >= $convert(<type -11>, 0 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //14\\n { //16\\n  $ret0 = (r * $convert(<type -8>, 1 )) //16\\n  return //16\\n } //0\\n\22"
module asm "\09.ascii \22checksum ECF30896F615C874698FC0AB79C459B11254FCE4\\n\22"
module asm "\09.text"
