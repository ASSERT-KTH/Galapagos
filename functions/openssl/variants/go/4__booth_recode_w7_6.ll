; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_6.bc'
...
module asm "\09.ascii \22boothRecodeW7_6\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_6.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 7 )) - 1 ) //4\\n var d <type -7> = ((256  - in) - 1 ) //5\\n d = ((d & s) | (in & ^s)) //6\\n d = ((d >> $convert(<type -12>, 1 )) + (d & $convert(<type -7>, 1 ))) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 582AB5B61BEB642BE44F7464536B6C169E50E173\\n\22"
module asm "\09.text"
...
define i32 @main.boothRecodeW7__6(i8* nest nocapture readnone %nest.0, i32 %in) local_unnamed_addr #1 {
entry:
  %shr.0 = lshr i32 %in, 7
