; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_0.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_0.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 5 )) - 1 ) //4\\n var d <type -7> = ((64  - in) - 1 ) //5\\n d = ((d & s) | (in & ^s)) //6\\n d = ((d >> $convert(<type -12>, 1 )) + (d & $convert(<type -7>, 1 ))) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 153A2C2D10D27303F5CABB3F10DEF15D949FF3B6\\n\22"
module asm "\09.text"
