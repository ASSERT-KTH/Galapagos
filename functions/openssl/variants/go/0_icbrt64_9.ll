; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/0_icbrt64_9.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/0_icbrt64_9.go:3\\n var r <type -8> = 0  //4\\n { //6\\n  var s <type -12> = 63  //6\\n  { /*for*/ //6\\n   goto $l0 //6\\n   :$l1 //6\\n   { //6\\n    r = (r << $convert(<type -12>, 1 )) //7\\n    var b <type -8> = (((3  * r) * (r + 1 )) + 1 ) //8\\n    { //9\\n     if ((x >> s) >= b) { //9\\n      x = (x - (b << s)) //10\\n      r = (r + $convert(<type -8>, 1 )) //11\\n     } //9\\n    } //12\\n   } //13\\n   { //6\\n    s = (s - $convert(<type -12>, 3 )) //6\\n   } //6\\n   :$l0 //6\\n   if ($convert(<type -11>, s) >= $convert(<type -11>, 0 )) { //6\\n    goto $l1 //6\\n   } //6\\n  } //6\\n } //13\\n { //15\\n  $ret0 = (r * $convert(<type -8>, 1 )) //15\\n  return //15\\n } //0\\n\22"
module asm "\09.ascii \22checksum 7F4DFFEBA4009B7B277B051E44E19FCC1FAD8F38\\n\22"
module asm "\09.text"
