; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/1_BitDeinterleave_4.bc'
...
entry:
  %mod.0 = and i64 %Ai, 1
  %icmp.3.not = icmp eq i64 %mod.0, 0
  br i1 %icmp.3.not, label %fallthrough.3, label %then.3
