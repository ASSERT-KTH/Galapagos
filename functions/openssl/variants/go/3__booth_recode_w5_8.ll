; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_8.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_8.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 5 )) - 1 ) //4\\n var d <type -7> = (63  - in) //5\\n { //6\\n  if (s == $convert(<type -7>, 4294967295 )) { //6\\n   d = in //7\\n  } //6\\n } //8\\n var t <type -7> = ((d >> $convert(<type -12>, 1 )) + (d & 1 )) //9\\n { //11\\n  $ret0 = ((t << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //11\\n  return //11\\n } //0\\n\22"
module asm "\09.ascii \22checksum 4E2FADF6B1FDEEEE8ABF3683ADECC4D4C73EC6F3\\n\22"
module asm "\09.text"
...
entry:
  %shr.0 = lshr i32 %in, 5
  %sub.1 = sub i32 63, %in
  %icmp.0 = icmp eq i32 %shr.0, 1
  %spec.select = select i1 %icmp.0, i32 %in, i32 %sub.1
