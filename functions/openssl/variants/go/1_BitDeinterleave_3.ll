; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/1_BitDeinterleave_3.bc'
...
module asm "\09.ascii \22<type -8>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:690>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/1_BitDeinterleave_3.go:3\\n { //4\\n  if (Ai == $convert(<type -8>, 0 )) { //4\\n   { //5\\n    $ret0 = $convert(<type -8>, 0 ) //5\\n    return //5\\n   } //0\\n  } //4\\n } //6\\n { //8\\n  if (Ai == $convert(<type -8>, 18374966859414961920 )) { //8\\n   { //9\\n    $ret0 = Ai //9\\n    return //9\\n   } //0\\n  } //8\\n } //10\\n { //12\\n  if (Ai == $convert(<type -8>, 17361641481138401520 )) { //12\\n   { //13\\n    $ret0 = Ai //13\\n    return //13\\n   } //0\\n  } //12\\n } //14\\n { //16\\n  if (Ai == $convert(<type -8>, 14757395258967641292 )) { //16\\n   { //17\\n    $ret0 = Ai //17\\n    return //17\\n   } //0\\n  } //16\\n } //18\\n { //20\\n  $ret0 = Ai //20\\n  return //20\\n } //0\\n\22"
module asm "\09.ascii \22checksum 0C32F0EB3F0F12CF10F9DAFB415DD25DA0F5C15F\\n\22"
module asm "\09.text"
