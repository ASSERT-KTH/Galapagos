; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_8.bc'
...
module asm "\09.ascii \22boothRecodeW7_8\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_8.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 7 )) - 1 ) //4\\n var d <type -7> = (255  - in) //5\\n d = ((d & s) | (in & ^s)) //6\\n d = ((d >> $convert(<type -12>, 1 )) + (d & $convert(<type -7>, 1 ))) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 7F0A7A1F3164C4627725861ED10B65194FC15AB1\\n\22"
module asm "\09.text"
...
define i32 @main.boothRecodeW7__8(i8* nest nocapture readnone %nest.0, i32 %in) local_unnamed_addr #1 {
entry:
  %shr.0 = lshr i32 %in, 7
