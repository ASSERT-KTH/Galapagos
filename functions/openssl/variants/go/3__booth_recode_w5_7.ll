; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_7.bc'
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_7.go:3\\n var s <type -7> = ^$convert(<type -7>, ((in >> $convert(<type -12>, 5 )) - $convert(<type -7>, 1 ))) //4\\n var d <type -7> = (63  - in) //5\\n { //6\\n  if (s == $convert(<type -7>, 4294967295 )) { //6\\n   d = in //7\\n  } //6\\n } //8\\n d = ((d >> $convert(<type -12>, 1 )) + (d & $convert(<type -7>, 1 ))) //9\\n { //11\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //11\\n  return //11\\n } //0\\n\22"
module asm "\09.ascii \22checksum E55DF29DD9A057D8B1389BC5FDDCBB858140F6C6\\n\22"
module asm "\09.text"
