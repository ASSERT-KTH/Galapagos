; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_5.bc'
...
module asm "\09.ascii \22<type -7>\22"
module asm "\09.ascii \22)\22"
module asm "\09.ascii \22 <inl:401>\\n\22"
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/3__booth_recode_w5_5.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 5 )) - 1 ) //4\\n var d <type -7> = ((64  - in) - 1 ) //5\\n d = (((d & s) | (in & ^s)) >> $convert(<type -12>, 1 )) //6\\n d = (d + (d & $convert(<type -7>, 1 ))) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum 436FC4AF4F6773D8AA03E747DB2A2DE34A9183D1\\n\22"
module asm "\09.text"
...
entry:
  ...
  %shr.1 = lshr i32 %ior.0, 1
  %iand.2 = and i32 %shr.1, 1
  %add.0 = add nuw i32 %iand.2, %shr.1
  %shl.0 = shl i32 %add.0, 1
