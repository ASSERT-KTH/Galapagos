; ModuleID = '/home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_2.bc'
...
module asm "\09.ascii \22boothRecodeW7_2\22"
module asm "\09.ascii \22 (\22"
...
module asm "\09.ascii \22 // /home/javier/Galapagos/functions/openssl/variants/go/4__booth_recode_w7_2.go:3\\n var s <type -7> = ^((in >> $convert(<type -12>, 7 )) - 1 ) //4\\n var d <type -7> = (255  - in) //5\\n d = ((d & s) | (in & ^s)) //6\\n d = ((d + (d & $convert(<type -7>, 1 ))) >> $convert(<type -12>, 1 )) //7\\n { //9\\n  $ret0 = ((d << $convert(<type -12>, 1 )) + (s & $convert(<type -7>, 1 ))) //9\\n  return //9\\n } //0\\n\22"
module asm "\09.ascii \22checksum AB3EBFE4C7672A52AD2EDF6F23CB049B077CD6B2\\n\22"
module asm "\09.text"
...
define i32 @main.boothRecodeW7__2(i8* nest nocapture readnone %nest.0, i32 %in) local_unnamed_addr #1 {
entry:
  %shr.0 = lshr i32 %in, 7
  ...
  %iand.2 = and i32 %ior.0, 1
  %add.0 = add i32 %iand.2, %ior.0
  %shr.1 = and i32 %add.0, -2
  %iand.3 = and i32 %xor.0, 1
  %add.1 = or i32 %shr.1, %iand.3
  ret i32 %add.1
}
