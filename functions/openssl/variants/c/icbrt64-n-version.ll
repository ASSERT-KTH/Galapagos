...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_2(i64 noundef %x) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_3(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_4(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  %result = alloca i64, align 8
  ...
  store i64 %x, ptr %x.addr, align 8
  store i64 0, ptr %result, align 8
  store i32 63, ptr %shift, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %mul1 = mul i64 %mul, %add
  %add2 = add i64 %mul1, 1
  store i64 %add2, ptr %bit, align 8
  %4 = load i64, ptr %x.addr, align 8
...
for.inc:                                          ; preds = %if.end
  ...
  %sub6 = sub nsw i32 %11, 3
  store i32 %sub6, ptr %shift, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_5(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %b = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_6(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  %result = alloca i64, align 8
  %b = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_7(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  %result = alloca i64, align 8
  %bit = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i64 @version_8(i64 noundef %x) #0 {
entry:
  %x.addr = alloca i64, align 8
  %r = alloca i64, align 8
  %b = alloca i64, align 8
