...
static void fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_addcarryx_u32(
    ...
    uint32_t arg3) {
    uint64_t tmpl;
    tmpl = ((uint64_t)arg1 + arg2 + arg3);
    *out1 = (uint32_t)(tmpl & UINT32_C(0xffffffff));
    *out2 = (fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1)(tmpl >> 32);
}
...
static void fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_addcarryx_u32(
    ...
    uint32_t arg3) {
    uint64_t tmp_res;
    tmp_res = ((uint64_t)arg1 + arg2) + arg3;
    *out1 = (uint32_t)(tmp_res & UINT32_C(0xffffffff));
    *out2 = (fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1)(tmp_res >> 32);
}
