static void fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_addcarryx_u32(
    ...
    x1 = (uint64_t)((uint32_t)(arg1 + (uint64_t)arg2) + arg3);
    x2 = x1 % UINT32_C(0x100000000);
    x3 = (fiat_id_GostR3410_2001_CryptoPro_C_ParamSet_uint1)(x1 / UINT32_C(0x100000000));
    if (out1 != NULL) *out1 = x2;
    if (out2 != NULL) *out2 = x3;
}
